...
public class AadlPackageItemProvider extends ModelUnitItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_AadlPackage_publicSection_feature", "_UI_AadlPackage_type"),
				 Aadl2Package.eINSTANCE.getAadlPackage_PublicSection(),
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_AadlPackage_privateSection_feature", "_UI_AadlPackage_type"),
				 Aadl2Package.eINSTANCE.getAadlPackage_PrivateSection(),
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_AadlPackage_type") :
