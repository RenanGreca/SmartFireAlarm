		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_AbstractFeature_featurePrototype_feature", "_UI_AbstractFeature_type"),
	...
	protected void addAbstractFeatureClassifierPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AbstractFeature_abstractFeatureClassifier_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AbstractFeature_abstractFeatureClassifier_feature", "_UI_AbstractFeature_type"),
				 Aadl2Package.eINSTANCE.getAbstractFeature_AbstractFeatureClassifier(),
				 true,
				 false,
				 true,
				 null,
