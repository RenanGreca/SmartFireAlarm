...
public class AbstractSubcomponentItemProvider extends SubcomponentItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_AbstractSubcomponent_abstractSubcomponentType_feature", "_UI_AbstractSubcomponent_type"),
				 Aadl2Package.eINSTANCE.getAbstractSubcomponent_AbstractSubcomponentType(),
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_AbstractSubcomponent_type") :
