...
public class AccessSpecificationItemProvider extends FeaturePrototypeActualItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_AccessSpecification_kind_feature", "_UI_AccessSpecification_type"),
				 Aadl2Package.eINSTANCE.getAccessSpecification_Kind(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_AccessSpecification_category_feature", "_UI_AccessSpecification_type"),
				 Aadl2Package.eINSTANCE.getAccessSpecification_Category(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_AccessSpecification_classifier_feature", "_UI_AccessSpecification_type"),
				 Aadl2Package.eINSTANCE.getAccessSpecification_Classifier(),
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_AccessSpecification_componentPrototype_feature", "_UI_AccessSpecification_type"),
				 Aadl2Package.eINSTANCE.getAccessSpecification_ComponentPrototype(),
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_AccessSpecification_type") :
