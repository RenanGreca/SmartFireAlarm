...
public class BasicPropertyItemProvider extends TypedElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_BasicProperty_referencedPropertyType_feature", "_UI_BasicProperty_type"),
				 Aadl2Package.eINSTANCE.getBasicProperty_ReferencedPropertyType(),
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_BasicProperty_propertyType_feature", "_UI_BasicProperty_type"),
				 Aadl2Package.eINSTANCE.getBasicProperty_PropertyType(),
				 false,
				 false,
				 false,
				 null,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_BasicProperty_type") :
