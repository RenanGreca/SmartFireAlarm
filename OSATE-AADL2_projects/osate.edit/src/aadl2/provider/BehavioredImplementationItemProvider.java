...
/**
 * This is the item provider adapter for a {@link aadl2.BehavioredImplementation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BehavioredImplementationItemProvider extends ComponentImplementationItemProvider {
	/**
	 ...
	 * @generated
	 */
	public BehavioredImplementationItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_BehavioredImplementation_subprogramCall_feature", "_UI_BehavioredImplementation_type"),
				 Aadl2Package.eINSTANCE.getBehavioredImplementation_SubprogramCall(),
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((BehavioredImplementation)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_BehavioredImplementation_type") :
			getString("_UI_BehavioredImplementation_type") + " " + label;
	}
