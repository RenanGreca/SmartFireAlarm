		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_BusAccess_busFeatureClassifier_feature", "_UI_BusAccess_type"),
				 Aadl2Package.eINSTANCE.getBusAccess_BusFeatureClassifier(),
				 true,
				 false,
				 true,
				 null,
	...
	protected void addVirtualPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BusAccess_virtual_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BusAccess_virtual_feature", "_UI_BusAccess_type"),
				 Aadl2Package.eINSTANCE.getBusAccess_Virtual(),
				 true,
				 false,
				 false,
