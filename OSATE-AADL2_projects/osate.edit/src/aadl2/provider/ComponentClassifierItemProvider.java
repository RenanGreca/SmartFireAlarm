...
public class ComponentClassifierItemProvider extends ClassifierItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ComponentClassifier_derivedModes_feature", "_UI_ComponentClassifier_type"),
				 Aadl2Package.eINSTANCE.getComponentClassifier_DerivedModes(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ComponentClassifier_noFlows_feature", "_UI_ComponentClassifier_type"),
				 Aadl2Package.eINSTANCE.getComponentClassifier_NoFlows(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ComponentClassifier_noModes_feature", "_UI_ComponentClassifier_type"),
				 Aadl2Package.eINSTANCE.getComponentClassifier_NoModes(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_ComponentClassifier_type") :
