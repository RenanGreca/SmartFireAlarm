...
public class ComponentImplementationItemProvider extends ComponentClassifierItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ComponentImplementation_ownedSubcomponent_feature", "_UI_ComponentImplementation_type"),
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ComponentImplementation_extended_feature", "_UI_ComponentImplementation_type"),
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ComponentImplementation_ownedConnection_feature", "_UI_ComponentImplementation_type"),
				 Aadl2Package.eINSTANCE.getComponentImplementation_OwnedConnection(),
				 false,
				 false,
				 false,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ComponentImplementation_noSubcomponents_feature", "_UI_ComponentImplementation_type"),
				 Aadl2Package.eINSTANCE.getComponentImplementation_NoSubcomponents(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ComponentImplementation_noConnections_feature", "_UI_ComponentImplementation_type"),
				 Aadl2Package.eINSTANCE.getComponentImplementation_NoConnections(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ComponentImplementation_noCalls_feature", "_UI_ComponentImplementation_type"),
	...
	protected void addOwnedProcessorFeaturePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ComponentImplementation_ownedProcessorFeature_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ComponentImplementation_ownedProcessorFeature_feature", "_UI_ComponentImplementation_type"),
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ComponentImplementation_ownedInternalFeature_feature", "_UI_ComponentImplementation_type"),
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Aadl2Package.eINSTANCE.getComponentImplementation_OwnedExtension(),
		...
		newChildDescriptors.add
			(createChildParameter
				(Aadl2Package.eINSTANCE.getComponentImplementation_OwnedEventSource(),
				 Aadl2Factory.eINSTANCE.createEventSource()));

		newChildDescriptors.add
			(createChildParameter
				(Aadl2Package.eINSTANCE.getComponentImplementation_OwnedEventDataSource(),
				 Aadl2Factory.eINSTANCE.createEventDataSource()));

		newChildDescriptors.add
			(createChildParameter
				(Aadl2Package.eINSTANCE.getComponentImplementation_OwnedPortProxy(),
				 Aadl2Factory.eINSTANCE.createPortProxy()));

		newChildDescriptors.add
			(createChildParameter
				(Aadl2Package.eINSTANCE.getComponentImplementation_OwnedSubprogramProxy(),
