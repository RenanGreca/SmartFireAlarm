...
/**
 * This is the item provider adapter for a {@link aadl2.ComponentPrototypeActual} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ComponentPrototypeActualItemProvider extends ArrayableElementItemProvider {
	/**
	 ...
	 * @generated
	 */
	public ComponentPrototypeActualItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ComponentPrototypeActual_category_feature", "_UI_ComponentPrototypeActual_type"),
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ComponentPrototypeActual_subcomponentType_feature", "_UI_ComponentPrototypeActual_type"),
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_ComponentPrototypeActual_type") :
