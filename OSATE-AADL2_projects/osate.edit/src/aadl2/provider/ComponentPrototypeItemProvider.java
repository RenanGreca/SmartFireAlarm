...
public class ComponentPrototypeItemProvider extends PrototypeItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ComponentPrototype_array_feature", "_UI_ComponentPrototype_type"),
				 Aadl2Package.eINSTANCE.getComponentPrototype_Array(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ComponentPrototype_constrainingClassifier_feature", "_UI_ComponentPrototype_type"),
				 Aadl2Package.eINSTANCE.getComponentPrototype_ConstrainingClassifier(),
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_ComponentPrototype_type") :
