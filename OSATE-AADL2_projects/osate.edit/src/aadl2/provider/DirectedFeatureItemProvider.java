...
/**
 * This is the item provider adapter for a {@link aadl2.DirectedFeature} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DirectedFeatureItemProvider extends FeatureItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_DirectedFeature_direction_feature", "_UI_DirectedFeature_type"),
				 Aadl2Package.eINSTANCE.getDirectedFeature_Direction(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_DirectedFeature_in_feature", "_UI_DirectedFeature_type"),
				 Aadl2Package.eINSTANCE.getDirectedFeature_In(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_DirectedFeature_out_feature", "_UI_DirectedFeature_type"),
				 Aadl2Package.eINSTANCE.getDirectedFeature_Out(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_DirectedFeature_type") :
			getString("_UI_DirectedFeature_type") + " " + label;
	}
