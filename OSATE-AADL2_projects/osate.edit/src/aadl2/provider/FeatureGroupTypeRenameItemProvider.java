...
public class FeatureGroupTypeRenameItemProvider extends NamedElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_FeatureGroupTypeRename_renamedFeatureGroupType_feature", "_UI_FeatureGroupTypeRename_type"),
				 Aadl2Package.eINSTANCE.getFeatureGroupTypeRename_RenamedFeatureGroupType(),
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_FeatureGroupTypeRename_type") :
