...
public class FeaturePrototypeReferenceItemProvider extends FeaturePrototypeActualItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_FeaturePrototypeReference_direction_feature", "_UI_FeaturePrototypeReference_type"),
				 Aadl2Package.eINSTANCE.getFeaturePrototypeReference_Direction(),
				 false,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_FeaturePrototypeReference_prototype_feature", "_UI_FeaturePrototypeReference_type"),
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_FeaturePrototypeReference_in_feature", "_UI_FeaturePrototypeReference_type"),
				 Aadl2Package.eINSTANCE.getFeaturePrototypeReference_In(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_FeaturePrototypeReference_out_feature", "_UI_FeaturePrototypeReference_type"),
				 Aadl2Package.eINSTANCE.getFeaturePrototypeReference_Out(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_FeaturePrototypeReference_type") :
