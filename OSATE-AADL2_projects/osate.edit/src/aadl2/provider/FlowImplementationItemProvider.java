...
public class FlowImplementationItemProvider extends ModalPathItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ClassifierFeature_featuringClassifier_feature", "_UI_ClassifierFeature_type"),
				 Aadl2Package.eINSTANCE.getClassifierFeature_FeaturingClassifier(),
				 false,
				 false,
				 false,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_FlowImplementation_kind_feature", "_UI_FlowImplementation_type"),
				 Aadl2Package.eINSTANCE.getFlowImplementation_Kind(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_FlowImplementation_specification_feature", "_UI_FlowImplementation_type"),
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_FlowImplementation_type") :
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Aadl2Package.eINSTANCE.getFlowImplementation_OwnedFlowSegment(),
				 Aadl2Factory.eINSTANCE.createFlowSegment()));

		newChildDescriptors.add
			(createChildParameter
				(Aadl2Package.eINSTANCE.getFlowImplementation_InEnd(),
				 Aadl2Factory.eINSTANCE.createFlowEnd()));

		newChildDescriptors.add
			(createChildParameter
				(Aadl2Package.eINSTANCE.getFlowImplementation_OutEnd(),
				 Aadl2Factory.eINSTANCE.createFlowEnd()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == Aadl2Package.eINSTANCE.getFlowImplementation_InEnd() ||
