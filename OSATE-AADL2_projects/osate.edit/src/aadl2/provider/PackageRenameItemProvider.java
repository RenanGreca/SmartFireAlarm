...
public class PackageRenameItemProvider extends NamedElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_PackageRename_renamedPackage_feature", "_UI_PackageRename_type"),
				 Aadl2Package.eINSTANCE.getPackageRename_RenamedPackage(),
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_PackageRename_renameAll_feature", "_UI_PackageRename_type"),
				 Aadl2Package.eINSTANCE.getPackageRename_RenameAll(),
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_PackageRename_type") :
