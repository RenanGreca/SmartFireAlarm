...
/**
 * This is the item provider adapter for a {@link aadl2.PortProxy} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PortProxyItemProvider extends ProcessorFeatureItemProvider {
	/**
	 ...
	 * @generated
	 */
	public PortProxyItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_PortProxy_direction_feature", "_UI_PortProxy_type"),
				 Aadl2Package.eINSTANCE.getPortProxy_Direction(),
				 false,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_PortProxy_dataClassifier_feature", "_UI_PortProxy_type"),
				 Aadl2Package.eINSTANCE.getPortProxy_DataClassifier(),
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Aadl2Package.eINSTANCE.getPortProxy_In(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Aadl2Package.eINSTANCE.getPortProxy_Out(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/PortProxy"));
	}
