...
public class PortSpecificationItemProvider extends FeaturePrototypeActualItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_PortSpecification_direction_feature", "_UI_PortSpecification_type"),
				 Aadl2Package.eINSTANCE.getPortSpecification_Direction(),
				 false,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_PortSpecification_category_feature", "_UI_PortSpecification_type"),
				 Aadl2Package.eINSTANCE.getPortSpecification_Category(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_PortSpecification_classifier_feature", "_UI_PortSpecification_type"),
				 Aadl2Package.eINSTANCE.getPortSpecification_Classifier(),
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_PortSpecification_componentPrototype_feature", "_UI_PortSpecification_type"),
				 Aadl2Package.eINSTANCE.getPortSpecification_ComponentPrototype(),
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_PortSpecification_in_feature", "_UI_PortSpecification_type"),
				 Aadl2Package.eINSTANCE.getPortSpecification_In(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_PortSpecification_out_feature", "_UI_PortSpecification_type"),
				 Aadl2Package.eINSTANCE.getPortSpecification_Out(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_PortSpecification_type") :
