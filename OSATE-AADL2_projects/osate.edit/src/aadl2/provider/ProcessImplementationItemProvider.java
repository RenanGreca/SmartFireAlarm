...
/**
 * This is the item provider adapter for a {@link aadl2.ProcessImplementation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProcessImplementationItemProvider extends ComponentImplementationItemProvider {
	/**
	 ...
	 * @generated
	 */
	public ProcessImplementationItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((ProcessImplementation)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ProcessImplementation_type") :
			getString("_UI_ProcessImplementation_type") + " " + label;
	}
