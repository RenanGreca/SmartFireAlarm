...
public class ProcessorImplementationItemProvider extends ComponentImplementationItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Aadl2Package.eINSTANCE.getProcessorImplementation_OwnedBusSubcomponent());
			childrenFeatures.add(Aadl2Package.eINSTANCE.getProcessorImplementation_OwnedMemorySubcomponent());
			childrenFeatures.add(Aadl2Package.eINSTANCE.getProcessorImplementation_OwnedVirtualBusSubcomponent());
			childrenFeatures.add(Aadl2Package.eINSTANCE.getProcessorImplementation_OwnedVirtualProcessorSubcomponent());
		}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_ProcessorImplementation_type") :
