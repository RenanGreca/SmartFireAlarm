...
public class PropertyConstantItemProvider extends TypedElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_PropertyConstant_referencedPropertyType_feature", "_UI_PropertyConstant_type"),
				 Aadl2Package.eINSTANCE.getPropertyConstant_ReferencedPropertyType(),
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_PropertyConstant_propertyType_feature", "_UI_PropertyConstant_type"),
				 Aadl2Package.eINSTANCE.getPropertyConstant_PropertyType(),
				 false,
				 false,
				 false,
				 null,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_PropertyConstant_type") :
