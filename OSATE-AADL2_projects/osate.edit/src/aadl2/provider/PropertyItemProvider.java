...
public class PropertyItemProvider extends BasicPropertyItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Aadl2Package.eINSTANCE.getProperty_Inherit(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_Property_appliesToMetaclass_feature", "_UI_Property_type"),
				 Aadl2Package.eINSTANCE.getProperty_AppliesToMetaclass(),
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_Property_appliesToClassifier_feature", "_UI_Property_type"),
				 Aadl2Package.eINSTANCE.getProperty_AppliesToClassifier(),
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_Property_emptyListDefault_feature", "_UI_Property_type"),
				 Aadl2Package.eINSTANCE.getProperty_EmptyListDefault(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == Aadl2Package.eINSTANCE.getProperty_DefaultValue() ||
