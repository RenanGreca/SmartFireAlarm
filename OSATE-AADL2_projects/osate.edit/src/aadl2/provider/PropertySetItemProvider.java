...
public class PropertySetItemProvider extends NamespaceItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_PropertySet_importedUnit_feature", "_UI_PropertySet_type"),
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_PropertySet_type") :
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Aadl2Package.eINSTANCE.getPropertySet_OwnedPropertyType(),
		...
		newChildDescriptors.add
			(createChildParameter
				(Aadl2Package.eINSTANCE.getPropertySet_OwnedProperty(),
				 Aadl2Factory.eINSTANCE.createProperty()));

		newChildDescriptors.add
			(createChildParameter
				(Aadl2Package.eINSTANCE.getPropertySet_OwnedPropertyConstant(),
