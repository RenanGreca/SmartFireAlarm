...
public class RefinableElementItemProvider extends NamedElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_RefinableElement_refinementContext_feature", "_UI_RefinableElement_type"),
				 Aadl2Package.eINSTANCE.getRefinableElement_RefinementContext(),
				 false,
				 false,
				 false,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_RefinableElement_refinedElement_feature", "_UI_RefinableElement_type"),
				 Aadl2Package.eINSTANCE.getRefinableElement_RefinedElement(),
				 false,
				 false,
				 false,
				 null,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_RefinableElement_type") :
