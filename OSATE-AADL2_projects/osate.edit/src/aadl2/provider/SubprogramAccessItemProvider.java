		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_SubprogramAccess_subprogramFeatureClassifier_feature", "_UI_SubprogramAccess_type"),
				 Aadl2Package.eINSTANCE.getSubprogramAccess_SubprogramFeatureClassifier(),
				 true,
				 false,
				 true,
				 null,
