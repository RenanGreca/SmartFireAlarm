...
public class SubprogramCallItemProvider extends BehavioralFeatureItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_SubprogramCall_calledSubprogram_feature", "_UI_SubprogramCall_type"),
				 Aadl2Package.eINSTANCE.getSubprogramCall_CalledSubprogram(),
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_SubprogramCall_context_feature", "_UI_SubprogramCall_type"),
				 Aadl2Package.eINSTANCE.getSubprogramCall_Context(),
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_SubprogramCall_type") :
