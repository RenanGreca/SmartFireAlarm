...
public class ThreadGroupSubcomponentItemProvider extends SubcomponentItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ThreadGroupSubcomponent_threadGroupSubcomponentType_feature", "_UI_ThreadGroupSubcomponent_type"),
				 Aadl2Package.eINSTANCE.getThreadGroupSubcomponent_ThreadGroupSubcomponentType(),
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_ThreadGroupSubcomponent_type") :
