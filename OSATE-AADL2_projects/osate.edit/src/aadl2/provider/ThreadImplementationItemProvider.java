...
/**
 * This is the item provider adapter for a {@link aadl2.ThreadImplementation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ThreadImplementationItemProvider extends BehavioredImplementationItemProvider {
	/**
	 ...
	 * @generated
	 */
	public ThreadImplementationItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Aadl2Package.eINSTANCE.getThreadImplementation_OwnedSubprogramGroupSubcomponent());
			childrenFeatures.add(Aadl2Package.eINSTANCE.getThreadImplementation_OwnedSubprogramSubcomponent());
			childrenFeatures.add(Aadl2Package.eINSTANCE.getThreadImplementation_OwnedDataSubcomponent());
		}
	...
	/**
	 * This returns ThreadImplementation.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public String getText(Object object) {
		String label = ((ThreadImplementation)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ThreadImplementation_type") :
			getString("_UI_ThreadImplementation_type") + " " + label;
	}
