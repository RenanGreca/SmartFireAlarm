...
/**
 * This is the item provider adapter for a {@link aadl2.VirtualProcessorImplementation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VirtualProcessorImplementationItemProvider extends ComponentImplementationItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Aadl2Package.eINSTANCE.getVirtualProcessorImplementation_OwnedVirtualBusSubcomponent());
			childrenFeatures.add(Aadl2Package.eINSTANCE.getVirtualProcessorImplementation_OwnedVirtualProcessorSubcomponent());
		}
	...
	/**
	 * This returns VirtualProcessorImplementation.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Aadl2Package.eINSTANCE.getVirtualProcessorImplementation_OwnedVirtualBusSubcomponent(),
				 Aadl2Factory.eINSTANCE.createVirtualBusSubcomponent()));

		newChildDescriptors.add
			(createChildParameter
				(Aadl2Package.eINSTANCE.getVirtualProcessorImplementation_OwnedVirtualProcessorSubcomponent(),
