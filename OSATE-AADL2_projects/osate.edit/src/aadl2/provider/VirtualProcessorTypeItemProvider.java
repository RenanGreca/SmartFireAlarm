...
/**
 * This is the item provider adapter for a {@link aadl2.VirtualProcessorType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VirtualProcessorTypeItemProvider extends ComponentTypeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public VirtualProcessorTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Aadl2Package.eINSTANCE.getVirtualProcessorType_OwnedDataPort());
			childrenFeatures.add(Aadl2Package.eINSTANCE.getVirtualProcessorType_OwnedEventDataPort());
	...
	/**
	 * This returns VirtualProcessorType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public String getText(Object object) {
		String label = ((VirtualProcessorType)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_VirtualProcessorType_type") :
			getString("_UI_VirtualProcessorType_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Aadl2Package.eINSTANCE.getVirtualProcessorType_OwnedDataPort(),
		...
		newChildDescriptors.add
			(createChildParameter
				(Aadl2Package.eINSTANCE.getVirtualProcessorType_OwnedEventPort(),
		...
		newChildDescriptors.add
			(createChildParameter
				(Aadl2Package.eINSTANCE.getVirtualProcessorType_OwnedBusAccess(),
