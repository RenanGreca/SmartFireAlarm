...
import aadl2.provider.PropertyAssociationItemProvider;
...
/**
 * This is the item provider adapter for a {@link instance.PropertyAssociationInstance} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PropertyAssociationInstanceItemProvider extends PropertyAssociationItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PropertyAssociationInstance_propertyAssociation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PropertyAssociationInstance_propertyAssociation_feature", "_UI_PropertyAssociationInstance_type"),
				 InstancePackage.Literals.PROPERTY_ASSOCIATION_INSTANCE__PROPERTY_ASSOCIATION,
				 true,
				 false,
				 true,
				 null,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/PropertyAssociationInstance"));
	}
	...
	public String getText(Object object) {
		...
		return getString("_UI_PropertyAssociationInstance_type") + " " + propertyAssociationInstance.isAppend();
	}
