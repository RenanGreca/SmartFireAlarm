...
/**
 * This is the item provider adapter for a {@link instance.SystemInstance} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SystemInstanceItemProvider extends ComponentInstanceItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SystemInstance_componentImplementation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SystemInstance_componentImplementation_feature", "_UI_SystemInstance_type"),
				 InstancePackage.Literals.SYSTEM_INSTANCE__COMPONENT_IMPLEMENTATION,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns SystemInstance.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SystemInstance"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_SystemInstance_type") :
			getString("_UI_SystemInstance_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(InstancePackage.Literals.SYSTEM_INSTANCE__SYSTEM_OPERATION_MODE,
