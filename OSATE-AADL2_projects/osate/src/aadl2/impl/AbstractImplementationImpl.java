 ...
 * </p>
 * <ul>
 *   <li>{@link aadl2.impl.AbstractImplementationImpl#getOwnedBusSubcomponent <em>Owned Bus Subcomponent</em>}</li>
 *   <li>{@link aadl2.impl.AbstractImplementationImpl#getOwnedDataSubcomponent <em>Owned Data Subcomponent</em>}</li>
 *   <li>{@link aadl2.impl.AbstractImplementationImpl#getOwnedDeviceSubcomponent <em>Owned Device Subcomponent</em>}</li>
 *   <li>{@link aadl2.impl.AbstractImplementationImpl#getOwnedMemorySubcomponent <em>Owned Memory Subcomponent</em>}</li>
 *   <li>{@link aadl2.impl.AbstractImplementationImpl#getOwnedProcessSubcomponent <em>Owned Process Subcomponent</em>}</li>
 *   <li>{@link aadl2.impl.AbstractImplementationImpl#getOwnedProcessorSubcomponent <em>Owned Processor Subcomponent</em>}</li>
 *   <li>{@link aadl2.impl.AbstractImplementationImpl#getOwnedSystemSubcomponent <em>Owned System Subcomponent</em>}</li>
 *   <li>{@link aadl2.impl.AbstractImplementationImpl#getOwnedSubprogramSubcomponent <em>Owned Subprogram Subcomponent</em>}</li>
 *   <li>{@link aadl2.impl.AbstractImplementationImpl#getOwnedSubprogramGroupSubcomponent <em>Owned Subprogram Group Subcomponent</em>}</li>
 *   <li>{@link aadl2.impl.AbstractImplementationImpl#getOwnedThreadSubcomponent <em>Owned Thread Subcomponent</em>}</li>
 *   <li>{@link aadl2.impl.AbstractImplementationImpl#getOwnedThreadGroupSubcomponent <em>Owned Thread Group Subcomponent</em>}</li>
 *   <li>{@link aadl2.impl.AbstractImplementationImpl#getOwnedVirtualBusSubcomponent <em>Owned Virtual Bus Subcomponent</em>}</li>
 *   <li>{@link aadl2.impl.AbstractImplementationImpl#getOwnedVirtualProcessorSubcomponent <em>Owned Virtual Processor Subcomponent</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AbstractImplementationImpl extends BehavioredImplementationImpl implements AbstractImplementation {
	...
	public EList<BusSubcomponent> getOwnedBusSubcomponent() {
		if (ownedBusSubcomponent == null) {
			ownedBusSubcomponent = new EObjectContainmentEList<BusSubcomponent>(BusSubcomponent.class, this, Aadl2Package.ABSTRACT_IMPLEMENTATION__OWNED_BUS_SUBCOMPONENT);
		}
	...
	public EList<DataSubcomponent> getOwnedDataSubcomponent() {
		if (ownedDataSubcomponent == null) {
			ownedDataSubcomponent = new EObjectContainmentEList<DataSubcomponent>(DataSubcomponent.class, this, Aadl2Package.ABSTRACT_IMPLEMENTATION__OWNED_DATA_SUBCOMPONENT);
		}
	...
	public EList<DeviceSubcomponent> getOwnedDeviceSubcomponent() {
		if (ownedDeviceSubcomponent == null) {
			ownedDeviceSubcomponent = new EObjectContainmentEList<DeviceSubcomponent>(DeviceSubcomponent.class, this, Aadl2Package.ABSTRACT_IMPLEMENTATION__OWNED_DEVICE_SUBCOMPONENT);
		}
	...
	public EList<MemorySubcomponent> getOwnedMemorySubcomponent() {
		if (ownedMemorySubcomponent == null) {
			ownedMemorySubcomponent = new EObjectContainmentEList<MemorySubcomponent>(MemorySubcomponent.class, this, Aadl2Package.ABSTRACT_IMPLEMENTATION__OWNED_MEMORY_SUBCOMPONENT);
		}
	...
	public EList<ProcessSubcomponent> getOwnedProcessSubcomponent() {
		if (ownedProcessSubcomponent == null) {
			ownedProcessSubcomponent = new EObjectContainmentEList<ProcessSubcomponent>(ProcessSubcomponent.class, this, Aadl2Package.ABSTRACT_IMPLEMENTATION__OWNED_PROCESS_SUBCOMPONENT);
		}
	...
	public EList<ProcessorSubcomponent> getOwnedProcessorSubcomponent() {
		if (ownedProcessorSubcomponent == null) {
			ownedProcessorSubcomponent = new EObjectContainmentEList<ProcessorSubcomponent>(ProcessorSubcomponent.class, this, Aadl2Package.ABSTRACT_IMPLEMENTATION__OWNED_PROCESSOR_SUBCOMPONENT);
		}
	...
	public EList<SystemSubcomponent> getOwnedSystemSubcomponent() {
		if (ownedSystemSubcomponent == null) {
			ownedSystemSubcomponent = new EObjectContainmentEList<SystemSubcomponent>(SystemSubcomponent.class, this, Aadl2Package.ABSTRACT_IMPLEMENTATION__OWNED_SYSTEM_SUBCOMPONENT);
		}
	...
	public EList<SubprogramSubcomponent> getOwnedSubprogramSubcomponent() {
		if (ownedSubprogramSubcomponent == null) {
			ownedSubprogramSubcomponent = new EObjectContainmentEList<SubprogramSubcomponent>(SubprogramSubcomponent.class, this, Aadl2Package.ABSTRACT_IMPLEMENTATION__OWNED_SUBPROGRAM_SUBCOMPONENT);
		}
	...
	public EList<SubprogramGroupSubcomponent> getOwnedSubprogramGroupSubcomponent() {
		if (ownedSubprogramGroupSubcomponent == null) {
			ownedSubprogramGroupSubcomponent = new EObjectContainmentEList<SubprogramGroupSubcomponent>(SubprogramGroupSubcomponent.class, this, Aadl2Package.ABSTRACT_IMPLEMENTATION__OWNED_SUBPROGRAM_GROUP_SUBCOMPONENT);
		}
	...
	public EList<ThreadSubcomponent> getOwnedThreadSubcomponent() {
		if (ownedThreadSubcomponent == null) {
			ownedThreadSubcomponent = new EObjectContainmentEList<ThreadSubcomponent>(ThreadSubcomponent.class, this, Aadl2Package.ABSTRACT_IMPLEMENTATION__OWNED_THREAD_SUBCOMPONENT);
		}
	...
	public EList<ThreadGroupSubcomponent> getOwnedThreadGroupSubcomponent() {
		if (ownedThreadGroupSubcomponent == null) {
			ownedThreadGroupSubcomponent = new EObjectContainmentEList<ThreadGroupSubcomponent>(ThreadGroupSubcomponent.class, this, Aadl2Package.ABSTRACT_IMPLEMENTATION__OWNED_THREAD_GROUP_SUBCOMPONENT);
		}
	...
	public EList<VirtualBusSubcomponent> getOwnedVirtualBusSubcomponent() {
		if (ownedVirtualBusSubcomponent == null) {
			ownedVirtualBusSubcomponent = new EObjectContainmentEList<VirtualBusSubcomponent>(VirtualBusSubcomponent.class, this, Aadl2Package.ABSTRACT_IMPLEMENTATION__OWNED_VIRTUAL_BUS_SUBCOMPONENT);
		}
	...
	public EList<VirtualProcessorSubcomponent> getOwnedVirtualProcessorSubcomponent() {
		if (ownedVirtualProcessorSubcomponent == null) {
			ownedVirtualProcessorSubcomponent = new EObjectContainmentEList<VirtualProcessorSubcomponent>(VirtualProcessorSubcomponent.class, this, Aadl2Package.ABSTRACT_IMPLEMENTATION__OWNED_VIRTUAL_PROCESSOR_SUBCOMPONENT);
		}
