	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case Aadl2Package.BUS_FEATURE_CLASSIFIER: {
				...
				if (result == null) result = caseFeatureClassifier(busFeatureClassifier);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Aadl2Package.AADL_PACKAGE: {
				...
				if (result == null) result = caseModelUnit(aadlPackage);
				if (result == null) result = caseNamedElement(aadlPackage);
				if (result == null) result = caseElement(aadlPackage);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Aadl2Package.ABSTRACT_TYPE: {
				...
				if (result == null) result = caseBusFeatureClassifier(abstractType);
			...
			case Aadl2Package.ABSTRACT_CLASSIFIER: {
				...
				if (result == null) result = caseBusFeatureClassifier(abstractClassifier);
			...
			case Aadl2Package.VIRTUAL_BUS_SUBCOMPONENT_TYPE: {
				...
				if (result == null) result = caseBusFeatureClassifier(virtualBusSubcomponentType);
				if (result == null) result = caseType(virtualBusSubcomponentType);
				if (result == null) result = caseFeatureClassifier(virtualBusSubcomponentType);
			...
			case Aadl2Package.BUS_SUBCOMPONENT_TYPE: {
				...
				if (result == null) result = caseBusFeatureClassifier(busSubcomponentType);
			...
			case Aadl2Package.ABSTRACT_IMPLEMENTATION: {
				...
				if (result == null) result = caseBusFeatureClassifier(abstractImplementation);
			...
			case Aadl2Package.VIRTUAL_BUS_SUBCOMPONENT: {
				...
				if (result == null) result = caseAccessConnectionEnd(virtualBusSubcomponent);
				...
				if (result == null) result = caseConnectionEnd(virtualBusSubcomponent);
			...
			case Aadl2Package.ABSTRACT_PROTOTYPE: {
				...
				if (result == null) result = caseBusFeatureClassifier(abstractPrototype);
			...
			case Aadl2Package.BUS_CLASSIFIER: {
				...
				if (result == null) result = caseBusFeatureClassifier(busClassifier);
			...
			case Aadl2Package.BUS_TYPE: {
				...
				if (result == null) result = caseBusFeatureClassifier(busType);
			...
			case Aadl2Package.BUS_IMPLEMENTATION: {
				...
				if (result == null) result = caseBusFeatureClassifier(busImplementation);
			...
			case Aadl2Package.BUS_PROTOTYPE: {
				...
				if (result == null) result = caseBusFeatureClassifier(busPrototype);
			...
			case Aadl2Package.VIRTUAL_BUS_CLASSIFIER: {
				...
				if (result == null) result = caseBusFeatureClassifier(virtualBusClassifier);
			...
			case Aadl2Package.VIRTUAL_BUS_TYPE: {
				...
				if (result == null) result = caseBusFeatureClassifier(virtualBusType);
			...
			case Aadl2Package.VIRTUAL_BUS_IMPLEMENTATION: {
				...
				if (result == null) result = caseBusFeatureClassifier(virtualBusImplementation);
			...
			case Aadl2Package.VIRTUAL_BUS_PROTOTYPE: {
				...
				if (result == null) result = caseBusFeatureClassifier(virtualBusPrototype);
