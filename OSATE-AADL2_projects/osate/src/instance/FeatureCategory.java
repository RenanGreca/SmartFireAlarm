 ...
 * <!-- end-user-doc -->
 * @see instance.InstancePackage#getFeatureCategory()
 * @model
 * @generated
 */
public enum FeatureCategory implements Enumerator {
	 ...
	 * @generated
	 */
	private static final FeatureCategory[] VALUES_ARRAY =
		new FeatureCategory[] {
			DATA_PORT,
			EVENT_PORT,
			EVENT_DATA_PORT,
	...
	public static FeatureCategory get(int value) {
		switch (value) {
			case DATA_PORT_VALUE: return DATA_PORT;
			case EVENT_PORT_VALUE: return EVENT_PORT;
			case EVENT_DATA_PORT_VALUE: return EVENT_DATA_PORT;
			case PARAMETER_VALUE: return PARAMETER;
			case BUS_ACCESS_VALUE: return BUS_ACCESS;
			case DATA_ACCESS_VALUE: return DATA_ACCESS;
			case SUBPROGRAM_ACCESS_VALUE: return SUBPROGRAM_ACCESS;
			case SUBPROGRAM_GROUP_ACCESS_VALUE: return SUBPROGRAM_GROUP_ACCESS;
