	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case InstancePackage.FEATURE_INSTANCE: {
				...
				if (result == null) result = caseConnectionInstanceEnd(featureInstance);
				if (result == null) result = caseInstanceObject(featureInstance);
				if (result == null) result = caseNamedElement(featureInstance);
				if (result == null) result = caseElement(featureInstance);
			...
			case InstancePackage.INSTANCE_OBJECT: {
				...
				if (result == null) result = caseNamedElement(instanceObject);
				if (result == null) result = caseElement(instanceObject);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case InstancePackage.ANNEX_INSTANCE: {
				...
				if (result == null) result = caseNamedElement(annexInstance);
				if (result == null) result = caseElement(annexInstance);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case InstancePackage.PROPERTY_ASSOCIATION_INSTANCE: {
				...
				if (result == null) result = casePropertyAssociation(propertyAssociationInstance);
				if (result == null) result = caseElement(propertyAssociationInstance);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case InstancePackage.CONNECTION_INSTANCE_END: {
				...
				if (result == null) result = caseInstanceObject(connectionInstanceEnd);
				if (result == null) result = caseNamedElement(connectionInstanceEnd);
				if (result == null) result = caseElement(connectionInstanceEnd);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case InstancePackage.CONNECTION_INSTANCE: {
				...
				if (result == null) result = caseFlowElementInstance(connectionInstance);
				if (result == null) result = caseInstanceObject(connectionInstance);
				if (result == null) result = caseNamedElement(connectionInstance);
			...
			case InstancePackage.FLOW_ELEMENT_INSTANCE: {
				...
				if (result == null) result = caseInstanceObject(flowElementInstance);
				if (result == null) result = caseNamedElement(flowElementInstance);
				if (result == null) result = caseElement(flowElementInstance);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case InstancePackage.SYSTEM_OPERATION_MODE: {
				...
				if (result == null) result = caseMode(systemOperationMode);
				if (result == null) result = caseModeFeature(systemOperationMode);
				if (result == null) result = caseClassifierFeature(systemOperationMode);
				if (result == null) result = caseNamedElement(systemOperationMode);
				if (result == null) result = caseElement(systemOperationMode);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case InstancePackage.MODE_INSTANCE: {
				...
				if (result == null) result = caseInstanceObject(modeInstance);
				if (result == null) result = caseNamedElement(modeInstance);
				if (result == null) result = caseElement(modeInstance);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case InstancePackage.MODE_TRANSITION_INSTANCE: {
				...
				if (result == null) result = caseConnectionInstanceEnd(modeTransitionInstance);
				if (result == null) result = caseInstanceObject(modeTransitionInstance);
				if (result == null) result = caseNamedElement(modeTransitionInstance);
				if (result == null) result = caseElement(modeTransitionInstance);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case InstancePackage.CONNECTION_REFERENCE: {
				...
				if (result == null) result = caseInstanceObject(connectionReference);
				if (result == null) result = caseNamedElement(connectionReference);
				if (result == null) result = caseElement(connectionReference);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case InstancePackage.COMPONENT_INSTANCE: {
				...
				if (result == null) result = caseConnectionInstanceEnd(componentInstance);
				if (result == null) result = caseFlowElementInstance(componentInstance);
				if (result == null) result = caseInstanceObject(componentInstance);
			...
			case InstancePackage.FLOW_SPECIFICATION_INSTANCE: {
				...
				if (result == null) result = caseFlowElementInstance(flowSpecificationInstance);
				if (result == null) result = caseInstanceObject(flowSpecificationInstance);
				if (result == null) result = caseNamedElement(flowSpecificationInstance);
				if (result == null) result = caseElement(flowSpecificationInstance);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case InstancePackage.END_TO_END_FLOW_INSTANCE: {
				...
				if (result == null) result = caseFlowElementInstance(endToEndFlowInstance);
				if (result == null) result = caseInstanceObject(endToEndFlowInstance);
				if (result == null) result = caseNamedElement(endToEndFlowInstance);
				if (result == null) result = caseElement(endToEndFlowInstance);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case InstancePackage.SYSTEM_INSTANCE: {
				...
				if (result == null) result = caseComponentInstance(systemInstance);
				if (result == null) result = caseConnectionInstanceEnd(systemInstance);
				if (result == null) result = caseFlowElementInstance(systemInstance);
				if (result == null) result = caseInstanceObject(systemInstance);
				if (result == null) result = caseNamedElement(systemInstance);
				if (result == null) result = caseElement(systemInstance);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case InstancePackage.INSTANCE_REFERENCE_VALUE: {
				...
				if (result == null) result = casePropertyValue(instanceReferenceValue);
				if (result == null) result = casePropertyExpression(instanceReferenceValue);
				if (result == null) result = caseElement(instanceReferenceValue);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
