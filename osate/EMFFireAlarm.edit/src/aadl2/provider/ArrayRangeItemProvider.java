...
/**
 * This is the item provider adapter for a {@link aadl2.ArrayRange} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArrayRangeItemProvider extends ElementItemProvider {
	/**
	 ...
	 * @generated
	 */
	public ArrayRangeItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ArrayRange_lowerBound_feature", "_UI_ArrayRange_type"),
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ArrayRange_upperBound_feature", "_UI_ArrayRange_type"),
