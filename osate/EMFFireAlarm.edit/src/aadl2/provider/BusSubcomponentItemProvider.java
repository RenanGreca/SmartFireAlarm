...
public class BusSubcomponentItemProvider extends SubcomponentItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_BusSubcomponent_busSubcomponentType_feature", "_UI_BusSubcomponent_type"),
				 Aadl2Package.eINSTANCE.getBusSubcomponent_BusSubcomponentType(),
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_BusSubcomponent_type") :
