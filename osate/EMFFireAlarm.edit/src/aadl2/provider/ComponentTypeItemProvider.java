...
/**
 * This is the item provider adapter for a {@link aadl2.ComponentType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ComponentType_ownedFeature_feature", "_UI_ComponentType_type"),
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ComponentType_extended_feature", "_UI_ComponentType_type"),
				 Aadl2Package.eINSTANCE.getComponentType_Extended(),
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ComponentType_noFeatures_feature", "_UI_ComponentType_type"),
				 Aadl2Package.eINSTANCE.getComponentType_NoFeatures(),
				 true,
				 false,
				 false,
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Aadl2Package.eINSTANCE.getComponentType_OwnedFlowSpecification(),
		...
		newChildDescriptors.add
			(createChildParameter
				(Aadl2Package.eINSTANCE.getComponentType_OwnedFeatureGroup(),
				 Aadl2Factory.eINSTANCE.createFeatureGroup()));

		newChildDescriptors.add
			(createChildParameter
				(Aadl2Package.eINSTANCE.getComponentType_OwnedAbstractFeature(),
