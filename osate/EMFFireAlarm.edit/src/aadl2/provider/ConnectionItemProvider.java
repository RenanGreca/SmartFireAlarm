		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_Connection_bidirectional_feature", "_UI_Connection_type"),
				 Aadl2Package.eINSTANCE.getConnection_Bidirectional(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_Connection_refined_feature", "_UI_Connection_type"),
				 Aadl2Package.eINSTANCE.getConnection_Refined(),
				 true,
				 false,
				 true,
				 null,
