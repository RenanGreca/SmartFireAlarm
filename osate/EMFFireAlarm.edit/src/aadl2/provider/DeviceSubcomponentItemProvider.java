...
/**
 * This is the item provider adapter for a {@link aadl2.DeviceSubcomponent} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DeviceSubcomponentItemProvider extends SubcomponentItemProvider {
	 ...
	 * @generated
	 */
	public DeviceSubcomponentItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_DeviceSubcomponent_deviceSubcomponentType_feature", "_UI_DeviceSubcomponent_type"),
				 Aadl2Package.eINSTANCE.getDeviceSubcomponent_DeviceSubcomponentType(),
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((DeviceSubcomponent)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_DeviceSubcomponent_type") :
			getString("_UI_DeviceSubcomponent_type") + " " + label;
	}
