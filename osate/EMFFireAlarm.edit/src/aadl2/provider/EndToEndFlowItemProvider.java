...
/**
 * This is the item provider adapter for a {@link aadl2.EndToEndFlow} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EndToEndFlowItemProvider extends FlowFeatureItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_EndToEndFlow_refined_feature", "_UI_EndToEndFlow_type"),
				 Aadl2Package.eINSTANCE.getEndToEndFlow_Refined(),
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((EndToEndFlow)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_EndToEndFlow_type") :
			getString("_UI_EndToEndFlow_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Aadl2Package.eINSTANCE.getEndToEndFlow_OwnedEndToEndFlowSegment(),
