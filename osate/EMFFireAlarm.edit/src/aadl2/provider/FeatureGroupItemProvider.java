		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_FeatureGroup_inverse_feature", "_UI_FeatureGroup_type"),
				 Aadl2Package.eINSTANCE.getFeatureGroup_Inverse(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_FeatureGroup_featureType_feature", "_UI_FeatureGroup_type"),
				 Aadl2Package.eINSTANCE.getFeatureGroup_FeatureType(),
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_FeatureGroup_featureGroupType_feature", "_UI_FeatureGroup_type"),
				 Aadl2Package.eINSTANCE.getFeatureGroup_FeatureGroupType(),
				 false,
				 false,
				 false,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_FeatureGroup_featureGroupPrototype_feature", "_UI_FeatureGroup_type"),
				 Aadl2Package.eINSTANCE.getFeatureGroup_FeatureGroupPrototype(),
				 false,
				 false,
				 false,
				 null,
