...
public class GlobalNamespaceItemProvider extends NamespaceItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_GlobalNamespace_package_feature", "_UI_GlobalNamespace_type"),
				 Aadl2Package.eINSTANCE.getGlobalNamespace_Package(),
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_GlobalNamespace_propertySet_feature", "_UI_GlobalNamespace_type"),
				 Aadl2Package.eINSTANCE.getGlobalNamespace_PropertySet(),
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_GlobalNamespace_type") :
