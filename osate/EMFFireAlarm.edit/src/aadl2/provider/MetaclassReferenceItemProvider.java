...
public class MetaclassReferenceItemProvider extends PropertyOwnerItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_MetaclassReference_annexName_feature", "_UI_MetaclassReference_type"),
				 Aadl2Package.eINSTANCE.getMetaclassReference_AnnexName(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_MetaclassReference_metaclassName_feature", "_UI_MetaclassReference_type"),
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_MetaclassReference_type") :
