...
/**
 * This is the item provider adapter for a {@link aadl2.ModalElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ModalElementItemProvider extends NamedElementItemProvider {
	 ...
	 * @generated
	 */
	public ModalElementItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((ModalElement)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ModalElement_type") :
			getString("_UI_ModalElement_type") + " " + label;
	}
