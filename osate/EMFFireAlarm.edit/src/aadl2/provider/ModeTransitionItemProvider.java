...
/**
 * This is the item provider adapter for a {@link aadl2.ModeTransition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ModeTransitionItemProvider extends ModeFeatureItemProvider {
	 ...
	 * @generated
	 */
	public ModeTransitionItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ModeTransition_source_feature", "_UI_ModeTransition_type"),
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ModeTransition_destination_feature", "_UI_ModeTransition_type"),
	...
	/**
	 * This returns ModeTransition.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public String getText(Object object) {
		String label = ((ModeTransition)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ModeTransition_type") :
			getString("_UI_ModeTransition_type") + " " + label;
	}
