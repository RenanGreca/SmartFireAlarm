...
/**
 * This is the item provider adapter for a {@link aadl2.NamedValue} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NamedValueItemProvider extends PropertyValueItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_NamedValue_namedValue_feature", "_UI_NamedValue_type"),
				 Aadl2Package.eINSTANCE.getNamedValue_NamedValue(),
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		return getString("_UI_NamedValue_type");
	}
