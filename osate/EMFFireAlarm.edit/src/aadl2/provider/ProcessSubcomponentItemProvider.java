...
public class ProcessSubcomponentItemProvider extends SubcomponentItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ProcessSubcomponent_processSubcomponentType_feature", "_UI_ProcessSubcomponent_type"),
				 Aadl2Package.eINSTANCE.getProcessSubcomponent_ProcessSubcomponentType(),
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_ProcessSubcomponent_type") :
