...
/**
 * This is the item provider adapter for a {@link aadl2.ProcessorType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProcessorTypeItemProvider extends ComponentTypeItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Aadl2Package.eINSTANCE.getProcessorType_OwnedDataPort());
			childrenFeatures.add(Aadl2Package.eINSTANCE.getProcessorType_OwnedEventDataPort());
			childrenFeatures.add(Aadl2Package.eINSTANCE.getProcessorType_OwnedEventPort());
			childrenFeatures.add(Aadl2Package.eINSTANCE.getProcessorType_OwnedBusAccess());
			childrenFeatures.add(Aadl2Package.eINSTANCE.getProcessorType_OwnedSubprogramAccess());
			childrenFeatures.add(Aadl2Package.eINSTANCE.getProcessorType_OwnedSubprogramGroupAccess());
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Aadl2Package.eINSTANCE.getProcessorType_OwnedDataPort(),
				 Aadl2Factory.eINSTANCE.createDataPort()));

		newChildDescriptors.add
			(createChildParameter
				(Aadl2Package.eINSTANCE.getProcessorType_OwnedEventDataPort(),
				 Aadl2Factory.eINSTANCE.createEventDataPort()));

		newChildDescriptors.add
			(createChildParameter
				(Aadl2Package.eINSTANCE.getProcessorType_OwnedEventPort(),
				 Aadl2Factory.eINSTANCE.createEventPort()));

		newChildDescriptors.add
			(createChildParameter
				(Aadl2Package.eINSTANCE.getProcessorType_OwnedBusAccess(),
				 Aadl2Factory.eINSTANCE.createBusAccess()));

		newChildDescriptors.add
			(createChildParameter
				(Aadl2Package.eINSTANCE.getProcessorType_OwnedSubprogramAccess(),
