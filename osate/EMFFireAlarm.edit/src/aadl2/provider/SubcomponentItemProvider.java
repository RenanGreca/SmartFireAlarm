...
public class SubcomponentItemProvider extends StructuralFeatureItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_Subcomponent_subcomponentType_feature", "_UI_Subcomponent_type"),
				 Aadl2Package.eINSTANCE.getSubcomponent_SubcomponentType(),
				 false,
				 false,
				 false,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_Subcomponent_prototype_feature", "_UI_Subcomponent_type"),
				 Aadl2Package.eINSTANCE.getSubcomponent_Prototype(),
				 false,
				 false,
				 false,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_Subcomponent_allModes_feature", "_UI_Subcomponent_type"),
				 Aadl2Package.eINSTANCE.getSubcomponent_AllModes(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_Subcomponent_refined_feature", "_UI_Subcomponent_type"),
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_Subcomponent_classifier_feature", "_UI_Subcomponent_type"),
				 Aadl2Package.eINSTANCE.getSubcomponent_Classifier(),
				 false,
				 false,
				 false,
				 null,
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Aadl2Package.eINSTANCE.getSubcomponent_OwnedModeBinding(),
				 Aadl2Factory.eINSTANCE.createModeBinding()));

		newChildDescriptors.add
			(createChildParameter
				(Aadl2Package.eINSTANCE.getSubcomponent_ImplementationReference(),
