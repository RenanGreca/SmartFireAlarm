...
/**
 * This is the item provider adapter for a {@link aadl2.UnitLiteral} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UnitLiteralItemProvider extends EnumerationLiteralItemProvider {
	...
	public String getText(Object object) {
		String label = ((UnitLiteral)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_UnitLiteral_type") :
			getString("_UI_UnitLiteral_type") + " " + label;
	}
