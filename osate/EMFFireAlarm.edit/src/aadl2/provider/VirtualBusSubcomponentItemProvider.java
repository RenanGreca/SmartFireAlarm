...
public class VirtualBusSubcomponentItemProvider extends SubcomponentItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_VirtualBusSubcomponent_virtualBusSubcomponentType_feature", "_UI_VirtualBusSubcomponent_type"),
				 Aadl2Package.eINSTANCE.getVirtualBusSubcomponent_VirtualBusSubcomponentType(),
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_VirtualBusSubcomponent_type") :
