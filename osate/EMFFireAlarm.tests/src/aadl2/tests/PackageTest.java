 ...
 * @generated
 */
public class PackageTest extends ModelUnitTest {
	 ...
	 */
	@Override
	protected aadl2.Package getFixture() {
		return (aadl2.Package)fixture;
	}
	...
	protected void setUp() throws Exception {
		setFixture(Aadl2Factory.eINSTANCE.createPackage());
	}
