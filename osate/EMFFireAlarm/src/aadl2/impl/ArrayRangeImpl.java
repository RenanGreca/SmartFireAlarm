 ...
 * </p>
 * <ul>
 *   <li>{@link aadl2.impl.ArrayRangeImpl#getLowerBound <em>Lower Bound</em>}</li>
 *   <li>{@link aadl2.impl.ArrayRangeImpl#getUpperBound <em>Upper Bound</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ArrayRangeImpl extends ElementImpl implements ArrayRange {
	...
	public void setLowerBound(long newLowerBound) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Aadl2Package.ARRAY_RANGE__LOWER_BOUND, oldLowerBound, lowerBound));
	}
	...
	public void setUpperBound(long newUpperBound) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Aadl2Package.ARRAY_RANGE__UPPER_BOUND, oldUpperBound, upperBound));
	}
