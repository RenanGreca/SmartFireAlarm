 ...
 * </p>
 * <ul>
 *   <li>{@link aadl2.impl.ConnectionImpl#getInMode <em>In Mode</em>}</li>
 *   <li>{@link aadl2.impl.ConnectionImpl#getInModeOrTransition <em>In Mode Or Transition</em>}</li>
 *   <li>{@link aadl2.impl.ConnectionImpl#getDestination <em>Destination</em>}</li>
 *   <li>{@link aadl2.impl.ConnectionImpl#getSource <em>Source</em>}</li>
 *   <li>{@link aadl2.impl.ConnectionImpl#isBidirectional <em>Bidirectional</em>}</li>
 *   <li>{@link aadl2.impl.ConnectionImpl#getRefined <em>Refined</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ConnectionImpl extends StructuralFeatureImpl implements Connection {
	...
	public EList<Mode> getInMode() {
		if (inMode == null) {
			inMode = new EObjectResolvingEList<Mode>(Mode.class, this, Aadl2Package.CONNECTION__IN_MODE);
		}
		return inMode;
	}
	...
	public EList<ModeFeature> getInModeOrTransition() {
		if (inModeOrTransition == null) {
			inModeOrTransition = new EObjectResolvingEList<ModeFeature>(ModeFeature.class, this, Aadl2Package.CONNECTION__IN_MODE_OR_TRANSITION);
		}
	...
	public void setDestination(ConnectedElement newDestination) {
		if (newDestination != destination) {
			...
			if (destination != null)
				msgs = ((InternalEObject)destination).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Aadl2Package.CONNECTION__DESTINATION, null, msgs);
			if (newDestination != null)
				msgs = ((InternalEObject)newDestination).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Aadl2Package.CONNECTION__DESTINATION, null, msgs);
			msgs = basicSetDestination(newDestination, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Aadl2Package.CONNECTION__DESTINATION, newDestination, newDestination));
	}
	...
	public void setSource(ConnectedElement newSource) {
		if (newSource != source) {
			NotificationChain msgs = null;
			if (source != null)
				msgs = ((InternalEObject)source).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Aadl2Package.CONNECTION__SOURCE, null, msgs);
			if (newSource != null)
				msgs = ((InternalEObject)newSource).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Aadl2Package.CONNECTION__SOURCE, null, msgs);
	...
	public void setBidirectional(boolean newBidirectional) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Aadl2Package.CONNECTION__BIDIRECTIONAL, oldBidirectional, bidirectional));
	}
	...
	public Connection getRefined() {
		if (refined != null && refined.eIsProxy()) {
			...
			if (refined != oldRefined) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Aadl2Package.CONNECTION__REFINED, oldRefined, refined));
			}
		}
		return refined;
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == ModalElement.class) {
			switch (derivedFeatureID) {
				case Aadl2Package.CONNECTION__IN_MODE: return Aadl2Package.MODAL_ELEMENT__IN_MODE;
				default: return -1;
			}
		}
		if (baseClass == ModalPath.class) {
			switch (derivedFeatureID) {
				case Aadl2Package.CONNECTION__IN_MODE_OR_TRANSITION: return Aadl2Package.MODAL_PATH__IN_MODE_OR_TRANSITION;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == ModalElement.class) {
			switch (baseFeatureID) {
				case Aadl2Package.MODAL_ELEMENT__IN_MODE: return Aadl2Package.CONNECTION__IN_MODE;
				default: return -1;
			}
		}
		if (baseClass == ModalPath.class) {
			switch (baseFeatureID) {
				case Aadl2Package.MODAL_PATH__IN_MODE_OR_TRANSITION: return Aadl2Package.CONNECTION__IN_MODE_OR_TRANSITION;
				default: return -1;
			}
		}
		if (baseClass == EndToEndFlowElement.class) {
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == ModalElement.class) {
			switch (baseOperationID) {
				case Aadl2Package.MODAL_ELEMENT___GET_ALL_IN_MODES: return Aadl2Package.CONNECTION___GET_ALL_IN_MODES;
				default: return -1;
			}
		}
		if (baseClass == ModalPath.class) {
			switch (baseOperationID) {
				case Aadl2Package.MODAL_PATH___GET_IN_MODES: return Aadl2Package.CONNECTION___GET_IN_MODES;
				case Aadl2Package.MODAL_PATH___GET_IN_MODE_TRANSITIONS: return Aadl2Package.CONNECTION___GET_IN_MODE_TRANSITIONS;
				case Aadl2Package.MODAL_PATH___GET_ALL_IN_MODE_TRANSITIONS: return Aadl2Package.CONNECTION___GET_ALL_IN_MODE_TRANSITIONS;
				default: return -1;
			}
		}
		if (baseClass == EndToEndFlowElement.class) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case Aadl2Package.CONNECTION___GET_IN_MODES:
				return getInModes();
			case Aadl2Package.CONNECTION___GET_IN_MODE_TRANSITIONS:
				return getInModeTransitions();
			case Aadl2Package.CONNECTION___GET_ALL_IN_MODE_TRANSITIONS:
				return getAllInModeTransitions();
			case Aadl2Package.CONNECTION___GET_ALL_IN_MODES:
