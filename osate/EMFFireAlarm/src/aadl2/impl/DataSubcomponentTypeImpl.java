...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Data Subcomponent Type</b></em>'.
 * <!-- end-user-doc -->
 *
 * @generated
 */
public abstract class DataSubcomponentTypeImpl extends DataImpl implements DataSubcomponentType {
	 ...
	 * @generated
	 */
	protected DataSubcomponentTypeImpl() {
		super();
	}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == Type.class) {
			switch (baseOperationID) {
				case Aadl2Package.TYPE___CONFORMS_TO__TYPE: return Aadl2Package.DATA_SUBCOMPONENT_TYPE___CONFORMS_TO__TYPE;
				default: return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case Aadl2Package.DATA_SUBCOMPONENT_TYPE___CONFORMS_TO__TYPE:
