...
public abstract class DeviceSubcomponentTypeImpl extends DeviceImpl implements DeviceSubcomponentType {
	 ...
	 * @generated
	 */
	protected DeviceSubcomponentTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Aadl2Package.eINSTANCE.getDeviceSubcomponentType();
	}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == Type.class) {
			switch (baseOperationID) {
				case Aadl2Package.TYPE___CONFORMS_TO__TYPE: return Aadl2Package.DEVICE_SUBCOMPONENT_TYPE___CONFORMS_TO__TYPE;
				default: return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case Aadl2Package.DEVICE_SUBCOMPONENT_TYPE___CONFORMS_TO__TYPE:
