 ...
 * </p>
 * <ul>
 *   <li>{@link aadl2.impl.FlowEndImpl#getContext <em>Context</em>}</li>
 *   <li>{@link aadl2.impl.FlowEndImpl#getFeature <em>Feature</em>}</li>
 * </ul>
 *
 * @generated
 */
		...
		if (context != null && context.eIsProxy()) {
			...
			if (context != oldContext) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Aadl2Package.FLOW_END__CONTEXT, oldContext, context));
			}
		}
		return context;
	}
	...
	public Feature getFeature() {
		if (feature != null && feature.eIsProxy()) {
			...
			if (feature != oldFeature) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Aadl2Package.FLOW_END__FEATURE, oldFeature, feature));
			}
		}
		return feature;
	}
