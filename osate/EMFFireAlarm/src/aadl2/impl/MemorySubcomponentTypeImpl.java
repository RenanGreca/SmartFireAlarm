...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Memory Subcomponent Type</b></em>'.
 * <!-- end-user-doc -->
 *
 * @generated
 */
public abstract class MemorySubcomponentTypeImpl extends MemoryImpl implements MemorySubcomponentType {
	 ...
	 * @generated
	 */
	protected MemorySubcomponentTypeImpl() {
		super();
	}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == Type.class) {
			switch (baseOperationID) {
				case Aadl2Package.TYPE___CONFORMS_TO__TYPE: return Aadl2Package.MEMORY_SUBCOMPONENT_TYPE___CONFORMS_TO__TYPE;
				default: return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case Aadl2Package.MEMORY_SUBCOMPONENT_TYPE___CONFORMS_TO__TYPE:
