 ...
 * </p>
 * <ul>
 *   <li>{@link aadl2.impl.MemoryTypeImpl#getOwnedBusAccess <em>Owned Bus Access</em>}</li>
 *   <li>{@link aadl2.impl.MemoryTypeImpl#getOwnedDataPort <em>Owned Data Port</em>}</li>
 *   <li>{@link aadl2.impl.MemoryTypeImpl#getOwnedEventDataPort <em>Owned Event Data Port</em>}</li>
 *   <li>{@link aadl2.impl.MemoryTypeImpl#getOwnedEventPort <em>Owned Event Port</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MemoryTypeImpl extends ComponentTypeImpl implements MemoryType {
	...
	public EList<BusAccess> getOwnedBusAccess() {
		if (ownedBusAccess == null) {
			ownedBusAccess = new EObjectContainmentEList<BusAccess>(BusAccess.class, this, Aadl2Package.MEMORY_TYPE__OWNED_BUS_ACCESS);
		}
	...
	public EList<DataPort> getOwnedDataPort() {
		if (ownedDataPort == null) {
			ownedDataPort = new EObjectContainmentEList<DataPort>(DataPort.class, this, Aadl2Package.MEMORY_TYPE__OWNED_DATA_PORT);
		}
	...
	public EList<EventDataPort> getOwnedEventDataPort() {
		if (ownedEventDataPort == null) {
			ownedEventDataPort = new EObjectContainmentEList<EventDataPort>(EventDataPort.class, this, Aadl2Package.MEMORY_TYPE__OWNED_EVENT_DATA_PORT);
		}
	...
	public EList<EventPort> getOwnedEventPort() {
		if (ownedEventPort == null) {
			ownedEventPort = new EObjectContainmentEList<EventPort>(EventPort.class, this, Aadl2Package.MEMORY_TYPE__OWNED_EVENT_PORT);
		}
