 ...
 * </p>
 * <ul>
 *   <li>{@link aadl2.impl.ModalPropertyValueImpl#getOwnedValue <em>Owned Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ModalPropertyValueImpl extends ModalElementImpl implements ModalPropertyValue {
	...
	public NotificationChain basicSetOwnedValue(PropertyExpression newOwnedValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Aadl2Package.MODAL_PROPERTY_VALUE__OWNED_VALUE, oldOwnedValue, newOwnedValue);
	...
	public void setOwnedValue(PropertyExpression newOwnedValue) {
		if (newOwnedValue != ownedValue) {
			...
			if (ownedValue != null)
				msgs = ((InternalEObject)ownedValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Aadl2Package.MODAL_PROPERTY_VALUE__OWNED_VALUE, null, msgs);
			if (newOwnedValue != null)
				msgs = ((InternalEObject)newOwnedValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Aadl2Package.MODAL_PROPERTY_VALUE__OWNED_VALUE, null, msgs);
			msgs = basicSetOwnedValue(newOwnedValue, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Aadl2Package.MODAL_PROPERTY_VALUE__OWNED_VALUE, newOwnedValue, newOwnedValue));
	}
