 ...
 * </p>
 * <ul>
 *   <li>{@link aadl2.impl.PackageImpl#getOwnedPublicSection <em>Owned Public Section</em>}</li>
 *   <li>{@link aadl2.impl.PackageImpl#getOwnedPrivateSection <em>Owned Private Section</em>}</li>
 *   <li>{@link aadl2.impl.PackageImpl#getPublicSection <em>Public Section</em>}</li>
 *   <li>{@link aadl2.impl.PackageImpl#getPrivateSection <em>Private Section</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PackageImpl extends ModelUnitImpl implements aadl2.Package {
	/**
	...
	protected EClass eStaticClass() {
		return Aadl2Package.eINSTANCE.getPackage();
	}
	...
	public NotificationChain basicSetOwnedPublicSection(PublicPackageSection newOwnedPublicSection, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Aadl2Package.PACKAGE__OWNED_PUBLIC_SECTION, oldOwnedPublicSection, newOwnedPublicSection);
	...
	public void setOwnedPublicSection(PublicPackageSection newOwnedPublicSection) {
		if (newOwnedPublicSection != ownedPublicSection) {
			...
			if (ownedPublicSection != null)
				msgs = ((InternalEObject)ownedPublicSection).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Aadl2Package.PACKAGE__OWNED_PUBLIC_SECTION, null, msgs);
			if (newOwnedPublicSection != null)
				msgs = ((InternalEObject)newOwnedPublicSection).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Aadl2Package.PACKAGE__OWNED_PUBLIC_SECTION, null, msgs);
			msgs = basicSetOwnedPublicSection(newOwnedPublicSection, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Aadl2Package.PACKAGE__OWNED_PUBLIC_SECTION, newOwnedPublicSection, newOwnedPublicSection));
	}
	...
	public NotificationChain basicSetOwnedPrivateSection(PrivatePackageSection newOwnedPrivateSection, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Aadl2Package.PACKAGE__OWNED_PRIVATE_SECTION, oldOwnedPrivateSection, newOwnedPrivateSection);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setOwnedPrivateSection(PrivatePackageSection newOwnedPrivateSection) {
		if (newOwnedPrivateSection != ownedPrivateSection) {
			...
			if (ownedPrivateSection != null)
				msgs = ((InternalEObject)ownedPrivateSection).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Aadl2Package.PACKAGE__OWNED_PRIVATE_SECTION, null, msgs);
			if (newOwnedPrivateSection != null)
				msgs = ((InternalEObject)newOwnedPrivateSection).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Aadl2Package.PACKAGE__OWNED_PRIVATE_SECTION, null, msgs);
			msgs = basicSetOwnedPrivateSection(newOwnedPrivateSection, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Aadl2Package.PACKAGE__OWNED_PRIVATE_SECTION, newOwnedPrivateSection, newOwnedPrivateSection));
	}
	...
	public PublicPackageSection getPublicSection() {
		if (publicSection != null && publicSection.eIsProxy()) {
			...
			if (publicSection != oldPublicSection) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Aadl2Package.PACKAGE__PUBLIC_SECTION, oldPublicSection, publicSection));
			}
		}
	...
	public void setPublicSection(PublicPackageSection newPublicSection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Aadl2Package.PACKAGE__PUBLIC_SECTION, oldPublicSection, publicSection));
	}
	...
	public PrivatePackageSection getPrivateSection() {
		if (privateSection != null && privateSection.eIsProxy()) {
			...
			if (privateSection != oldPrivateSection) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Aadl2Package.PACKAGE__PRIVATE_SECTION, oldPrivateSection, privateSection));
			}
		}
	...
	public void setPrivateSection(PrivatePackageSection newPrivateSection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Aadl2Package.PACKAGE__PRIVATE_SECTION, oldPrivateSection, privateSection));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Aadl2Package.PACKAGE__OWNED_PUBLIC_SECTION:
				return basicSetOwnedPublicSection(null, msgs);
			case Aadl2Package.PACKAGE__OWNED_PRIVATE_SECTION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case Aadl2Package.PACKAGE__PUBLIC_SECTION:
				if (resolve) return getPublicSection();
				return basicGetPublicSection();
			case Aadl2Package.PACKAGE__PRIVATE_SECTION:
