...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Process Subcomponent Type</b></em>'.
 * <!-- end-user-doc -->
 *
 * @generated
 */
public abstract class ProcessSubcomponentTypeImpl extends ProcessImpl implements ProcessSubcomponentType {
	 ...
	 * @generated
	 */
	protected ProcessSubcomponentTypeImpl() {
		super();
	}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == Type.class) {
			switch (baseOperationID) {
				case Aadl2Package.TYPE___CONFORMS_TO__TYPE: return Aadl2Package.PROCESS_SUBCOMPONENT_TYPE___CONFORMS_TO__TYPE;
				default: return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case Aadl2Package.PROCESS_SUBCOMPONENT_TYPE___CONFORMS_TO__TYPE:
