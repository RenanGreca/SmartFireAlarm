 ...
 * </p>
 * <ul>
 *   <li>{@link aadl2.impl.ProcessorFeatureImpl#getInMode <em>In Mode</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ProcessorFeatureImpl extends StructuralFeatureImpl implements ProcessorFeature {
	 ...
	 * @generated
	 */
	protected ProcessorFeatureImpl() {
		super();
	}
	...
	public EList<Mode> getInMode() {
		if (inMode == null) {
			inMode = new EObjectResolvingEList<Mode>(Mode.class, this, Aadl2Package.PROCESSOR_FEATURE__IN_MODE);
		}
		return inMode;
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == ModalElement.class) {
			switch (derivedFeatureID) {
				case Aadl2Package.PROCESSOR_FEATURE__IN_MODE: return Aadl2Package.MODAL_ELEMENT__IN_MODE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == ModalElement.class) {
			switch (baseFeatureID) {
				case Aadl2Package.MODAL_ELEMENT__IN_MODE: return Aadl2Package.PROCESSOR_FEATURE__IN_MODE;
				default: return -1;
			}
		}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == ModalElement.class) {
			switch (baseOperationID) {
				case Aadl2Package.MODAL_ELEMENT___GET_ALL_IN_MODES: return Aadl2Package.PROCESSOR_FEATURE___GET_ALL_IN_MODES;
				default: return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case Aadl2Package.PROCESSOR_FEATURE___GET_ALL_IN_MODES:
