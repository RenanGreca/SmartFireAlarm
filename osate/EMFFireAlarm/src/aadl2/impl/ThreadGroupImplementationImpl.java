 ...
 * </p>
 * <ul>
 *   <li>{@link aadl2.impl.ThreadGroupImplementationImpl#getOwnedDataSubcomponent <em>Owned Data Subcomponent</em>}</li>
 *   <li>{@link aadl2.impl.ThreadGroupImplementationImpl#getOwnedThreadSubcomponent <em>Owned Thread Subcomponent</em>}</li>
 *   <li>{@link aadl2.impl.ThreadGroupImplementationImpl#getOwnedThreadGroupSubcomponent <em>Owned Thread Group Subcomponent</em>}</li>
 *   <li>{@link aadl2.impl.ThreadGroupImplementationImpl#getOwnedSubprogramSubcomponent <em>Owned Subprogram Subcomponent</em>}</li>
 *   <li>{@link aadl2.impl.ThreadGroupImplementationImpl#getOwnedSubprogramGroupSubcomponent <em>Owned Subprogram Group Subcomponent</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ThreadGroupImplementationImpl extends ComponentImplementationImpl implements ThreadGroupImplementation {
	...
	public EList<DataSubcomponent> getOwnedDataSubcomponent() {
		if (ownedDataSubcomponent == null) {
			ownedDataSubcomponent = new EObjectContainmentEList<DataSubcomponent>(DataSubcomponent.class, this, Aadl2Package.THREAD_GROUP_IMPLEMENTATION__OWNED_DATA_SUBCOMPONENT);
		}
	...
	public EList<ThreadSubcomponent> getOwnedThreadSubcomponent() {
		if (ownedThreadSubcomponent == null) {
			ownedThreadSubcomponent = new EObjectContainmentEList<ThreadSubcomponent>(ThreadSubcomponent.class, this, Aadl2Package.THREAD_GROUP_IMPLEMENTATION__OWNED_THREAD_SUBCOMPONENT);
		}
	...
	public EList<ThreadGroupSubcomponent> getOwnedThreadGroupSubcomponent() {
		if (ownedThreadGroupSubcomponent == null) {
			ownedThreadGroupSubcomponent = new EObjectContainmentEList<ThreadGroupSubcomponent>(ThreadGroupSubcomponent.class, this, Aadl2Package.THREAD_GROUP_IMPLEMENTATION__OWNED_THREAD_GROUP_SUBCOMPONENT);
		}
	...
	public EList<SubprogramSubcomponent> getOwnedSubprogramSubcomponent() {
		if (ownedSubprogramSubcomponent == null) {
			ownedSubprogramSubcomponent = new EObjectContainmentEList<SubprogramSubcomponent>(SubprogramSubcomponent.class, this, Aadl2Package.THREAD_GROUP_IMPLEMENTATION__OWNED_SUBPROGRAM_SUBCOMPONENT);
		}
	...
	public EList<SubprogramGroupSubcomponent> getOwnedSubprogramGroupSubcomponent() {
		if (ownedSubprogramGroupSubcomponent == null) {
			ownedSubprogramGroupSubcomponent = new EObjectContainmentEList<SubprogramGroupSubcomponent>(SubprogramGroupSubcomponent.class, this, Aadl2Package.THREAD_GROUP_IMPLEMENTATION__OWNED_SUBPROGRAM_GROUP_SUBCOMPONENT);
		}
