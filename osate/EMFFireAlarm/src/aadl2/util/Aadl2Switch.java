...
public class Aadl2Switch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case Aadl2Package.PROPERTY_ASSOCIATION: {
				...
				if (result == null) result = caseElement(propertyAssociation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.PROPERTY: {
				...
				if (result == null) result = caseBasicProperty(property);
				if (result == null) result = caseAbstractNamedValue(property);
				if (result == null) result = caseArraySizeProperty(property);
			...
			case Aadl2Package.BASIC_PROPERTY: {
				...
				if (result == null) result = caseTypedElement(basicProperty);
				if (result == null) result = caseNamedElement(basicProperty);
				if (result == null) result = caseElement(basicProperty);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Aadl2Package.PROPERTY_TYPE: {
				...
				if (result == null) result = caseNamedElement(propertyType);
			...
			case Aadl2Package.METACLASS_REFERENCE: {
				...
				if (result == null) result = casePropertyOwner(metaclassReference);
				if (result == null) result = caseElement(metaclassReference);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.PROPERTY_OWNER: {
				...
				if (result == null) result = caseElement(propertyOwner);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Aadl2Package.CLASSIFIER_FEATURE: {
				...
				if (result == null) result = caseNamedElement(classifierFeature);
				if (result == null) result = caseElement(classifierFeature);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Aadl2Package.MODAL_ELEMENT: {
				...
				if (result == null) result = caseNamedElement(modalElement);
				if (result == null) result = caseElement(modalElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.MODE: {
				...
				if (result == null) result = caseModeFeature(mode);
				if (result == null) result = caseClassifierFeature(mode);
			...
			case Aadl2Package.MODE_FEATURE: {
				...
				if (result == null) result = caseClassifierFeature(modeFeature);
				if (result == null) result = caseNamedElement(modeFeature);
				if (result == null) result = caseElement(modeFeature);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.PROTOTYPE: {
				...
				if (result == null) result = caseStructuralFeature(prototype);
				if (result == null) result = caseCalledSubprogram(prototype);
				if (result == null) result = caseRefinableElement(prototype);
				if (result == null) result = caseClassifierFeature(prototype);
				if (result == null) result = caseNamedElement(prototype);
				if (result == null) result = caseElement(prototype);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.STRUCTURAL_FEATURE: {
				...
				if (result == null) result = caseRefinableElement(structuralFeature);
				if (result == null) result = caseClassifierFeature(structuralFeature);
			...
			case Aadl2Package.REFINABLE_ELEMENT: {
				...
				if (result == null) result = caseNamedElement(refinableElement);
				if (result == null) result = caseElement(refinableElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Aadl2Package.PROTOTYPE_BINDING: {
				...
				if (result == null) result = caseElement(prototypeBinding);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.CONTAINED_NAMED_ELEMENT: {
				...
				if (result == null) result = caseElement(containedNamedElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.CONTAINMENT_PATH_ELEMENT: {
				...
				if (result == null) result = caseElement(containmentPathElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Aadl2Package.MODAL_PROPERTY_VALUE: {
				...
				if (result == null) result = caseModalElement(modalPropertyValue);
				if (result == null) result = caseNamedElement(modalPropertyValue);
				if (result == null) result = caseElement(modalPropertyValue);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.BEHAVIORAL_FEATURE: {
				...
				if (result == null) result = caseClassifierFeature(behavioralFeature);
			...
			case Aadl2Package.ARRAY_DIMENSION: {
				...
				if (result == null) result = caseElement(arrayDimension);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Aadl2Package.ARRAYABLE_ELEMENT: {
				...
				if (result == null) result = caseElement(arrayableElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.COMPONENT_IMPLEMENTATION_REFERENCE: {
				...
				if (result == null) result = caseElement(componentImplementationReference);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.COMPONENT_IMPLEMENTATION: {
				...
				if (result == null) result = caseSubcomponentType(componentImplementation);
				if (result == null) result = caseFeatureClassifier(componentImplementation);
				if (result == null) result = caseNamespace(componentImplementation);
				if (result == null) result = caseType(componentImplementation);
				if (result == null) result = caseNamedElement(componentImplementation);
				if (result == null) result = caseElement(componentImplementation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.COMPONENT_CLASSIFIER: {
				...
				if (result == null) result = caseSubcomponentType(componentClassifier);
				if (result == null) result = caseFeatureClassifier(componentClassifier);
				if (result == null) result = caseNamespace(componentClassifier);
				if (result == null) result = caseType(componentClassifier);
				if (result == null) result = caseNamedElement(componentClassifier);
				if (result == null) result = caseElement(componentClassifier);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.SUBCOMPONENT_TYPE: {
				...
				if (result == null) result = caseType(subcomponentType);
				if (result == null) result = caseNamedElement(subcomponentType);
				if (result == null) result = caseElement(subcomponentType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Aadl2Package.MODE_TRANSITION: {
				...
				if (result == null) result = caseModeFeature(modeTransition);
				if (result == null) result = caseClassifierFeature(modeTransition);
				if (result == null) result = caseNamedElement(modeTransition);
				if (result == null) result = caseElement(modeTransition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.MODE_TRANSITION_TRIGGER: {
				...
				if (result == null) result = caseElement(modeTransitionTrigger);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Aadl2Package.TRIGGER_PORT: {
				...
				if (result == null) result = caseNamedElement(triggerPort);
			...
			case Aadl2Package.COMPONENT_TYPE: {
				...
				if (result == null) result = caseSubcomponentType(componentType);
				if (result == null) result = caseFeatureClassifier(componentType);
				if (result == null) result = caseNamespace(componentType);
			...
			case Aadl2Package.FEATURE: {
				...
				if (result == null) result = caseStructuralFeature(feature);
				if (result == null) result = caseFeatureConnectionEnd(feature);
				if (result == null) result = caseArrayableElement(feature);
				if (result == null) result = caseRefinableElement(feature);
				if (result == null) result = caseClassifierFeature(feature);
				if (result == null) result = caseConnectionEnd(feature);
			...
			case Aadl2Package.FEATURE_CONNECTION_END: {
				...
				if (result == null) result = caseConnectionEnd(featureConnectionEnd);
				if (result == null) result = caseNamedElement(featureConnectionEnd);
				if (result == null) result = caseElement(featureConnectionEnd);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.CONNECTION_END: {
				...
				if (result == null) result = caseNamedElement(connectionEnd);
			...
			case Aadl2Package.COMPONENT_PROTOTYPE: {
				...
				if (result == null) result = casePrototype(componentPrototype);
				if (result == null) result = caseSubcomponentType(componentPrototype);
				if (result == null) result = caseFeatureClassifier(componentPrototype);
				if (result == null) result = caseStructuralFeature(componentPrototype);
				if (result == null) result = caseCalledSubprogram(componentPrototype);
				if (result == null) result = caseType(componentPrototype);
				if (result == null) result = caseRefinableElement(componentPrototype);
				if (result == null) result = caseClassifierFeature(componentPrototype);
				if (result == null) result = caseNamedElement(componentPrototype);
				if (result == null) result = caseElement(componentPrototype);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.FLOW_SPECIFICATION: {
				...
				if (result == null) result = caseFlowFeature(flowSpecification);
				if (result == null) result = caseModalPath(flowSpecification);
				if (result == null) result = caseFlowElement(flowSpecification);
				if (result == null) result = caseStructuralFeature(flowSpecification);
				if (result == null) result = caseFlow(flowSpecification);
				if (result == null) result = caseModalElement(flowSpecification);
				if (result == null) result = caseEndToEndFlowElement(flowSpecification);
				if (result == null) result = caseRefinableElement(flowSpecification);
				if (result == null) result = caseClassifierFeature(flowSpecification);
			...
			case Aadl2Package.FLOW_FEATURE: {
				...
				if (result == null) result = caseStructuralFeature(flowFeature);
				if (result == null) result = caseFlow(flowFeature);
				if (result == null) result = caseRefinableElement(flowFeature);
				if (result == null) result = caseClassifierFeature(flowFeature);
				if (result == null) result = caseNamedElement(flowFeature);
				if (result == null) result = caseElement(flowFeature);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Aadl2Package.MODAL_PATH: {
				...
				if (result == null) result = caseModalElement(modalPath);
				if (result == null) result = caseNamedElement(modalPath);
				if (result == null) result = caseElement(modalPath);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.FLOW_ELEMENT: {
				...
				if (result == null) result = caseEndToEndFlowElement(flowElement);
			...
			case Aadl2Package.END_TO_END_FLOW_ELEMENT: {
				...
				if (result == null) result = caseNamedElement(endToEndFlowElement);
				if (result == null) result = caseElement(endToEndFlowElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.FLOW_END: {
				...
				if (result == null) result = caseElement(flowEnd);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.TYPE_EXTENSION: {
				...
				if (result == null) result = caseGeneralization(typeExtension);
				if (result == null) result = caseDirectedRelationship(typeExtension);
				if (result == null) result = caseRelationship(typeExtension);
			...
			case Aadl2Package.FEATURE_GROUP: {
				...
				if (result == null) result = caseFeatureGroupConnectionEnd(featureGroup);
				if (result == null) result = caseCallContext(featureGroup);
				if (result == null) result = caseFeature(featureGroup);
				if (result == null) result = caseStructuralFeature(featureGroup);
				if (result == null) result = caseFeatureConnectionEnd(featureGroup);
				if (result == null) result = caseArrayableElement(featureGroup);
				if (result == null) result = caseRefinableElement(featureGroup);
				if (result == null) result = caseClassifierFeature(featureGroup);
				if (result == null) result = caseConnectionEnd(featureGroup);
			...
			case Aadl2Package.DIRECTED_FEATURE: {
				...
				if (result == null) result = caseStructuralFeature(directedFeature);
				if (result == null) result = caseFeatureConnectionEnd(directedFeature);
				if (result == null) result = caseArrayableElement(directedFeature);
				if (result == null) result = caseRefinableElement(directedFeature);
				if (result == null) result = caseClassifierFeature(directedFeature);
				if (result == null) result = caseConnectionEnd(directedFeature);
				if (result == null) result = caseNamedElement(directedFeature);
				if (result == null) result = caseElement(directedFeature);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.FEATURE_GROUP_CONNECTION_END: {
				...
				if (result == null) result = caseConnectionEnd(featureGroupConnectionEnd);
				if (result == null) result = caseNamedElement(featureGroupConnectionEnd);
				if (result == null) result = caseElement(featureGroupConnectionEnd);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Aadl2Package.FEATURE_GROUP_TYPE: {
				...
				if (result == null) result = caseClassifier(featureGroupType);
				if (result == null) result = caseFeatureType(featureGroupType);
				if (result == null) result = caseNamespace(featureGroupType);
				if (result == null) result = caseType(featureGroupType);
				if (result == null) result = caseNamedElement(featureGroupType);
				if (result == null) result = caseElement(featureGroupType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.GROUP_EXTENSION: {
				...
				if (result == null) result = caseGeneralization(groupExtension);
				if (result == null) result = caseDirectedRelationship(groupExtension);
				if (result == null) result = caseRelationship(groupExtension);
				if (result == null) result = caseElement(groupExtension);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.BUS_ACCESS: {
				...
				if (result == null) result = caseBus(busAccess);
				if (result == null) result = caseFeature(busAccess);
				if (result == null) result = caseAccessConnectionEnd(busAccess);
				if (result == null) result = caseStructuralFeature(busAccess);
				if (result == null) result = caseFeatureConnectionEnd(busAccess);
				if (result == null) result = caseArrayableElement(busAccess);
				if (result == null) result = caseRefinableElement(busAccess);
				if (result == null) result = caseClassifierFeature(busAccess);
				if (result == null) result = caseConnectionEnd(busAccess);
				if (result == null) result = caseNamedElement(busAccess);
				if (result == null) result = caseElement(busAccess);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.ACCESS: {
				...
				if (result == null) result = caseAccessConnectionEnd(access);
				if (result == null) result = caseStructuralFeature(access);
				if (result == null) result = caseFeatureConnectionEnd(access);
				if (result == null) result = caseArrayableElement(access);
				if (result == null) result = caseRefinableElement(access);
				if (result == null) result = caseClassifierFeature(access);
				if (result == null) result = caseConnectionEnd(access);
				if (result == null) result = caseNamedElement(access);
			...
			case Aadl2Package.ACCESS_CONNECTION_END: {
				...
				if (result == null) result = caseConnectionEnd(accessConnectionEnd);
				if (result == null) result = caseNamedElement(accessConnectionEnd);
				if (result == null) result = caseElement(accessConnectionEnd);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Aadl2Package.BUS_SUBCOMPONENT_TYPE: {
				...
				if (result == null) result = caseBus(busSubcomponentType);
				if (result == null) result = caseSubcomponentType(busSubcomponentType);
				if (result == null) result = caseFeatureClassifier(busSubcomponentType);
				if (result == null) result = caseType(busSubcomponentType);
				if (result == null) result = caseNamedElement(busSubcomponentType);
				if (result == null) result = caseElement(busSubcomponentType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.DATA_ACCESS: {
				...
				if (result == null) result = caseData(dataAccess);
				if (result == null) result = caseFlowElement(dataAccess);
				if (result == null) result = caseParameterConnectionEnd(dataAccess);
				if (result == null) result = casePortConnectionEnd(dataAccess);
				if (result == null) result = caseFeature(dataAccess);
				if (result == null) result = caseAccessConnectionEnd(dataAccess);
				if (result == null) result = caseEndToEndFlowElement(dataAccess);
				if (result == null) result = caseStructuralFeature(dataAccess);
				if (result == null) result = caseFeatureConnectionEnd(dataAccess);
				if (result == null) result = caseArrayableElement(dataAccess);
				if (result == null) result = caseRefinableElement(dataAccess);
				if (result == null) result = caseClassifierFeature(dataAccess);
				if (result == null) result = caseConnectionEnd(dataAccess);
				if (result == null) result = caseNamedElement(dataAccess);
				if (result == null) result = caseElement(dataAccess);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.PARAMETER_CONNECTION_END: {
				...
				if (result == null) result = caseConnectionEnd(parameterConnectionEnd);
				if (result == null) result = caseNamedElement(parameterConnectionEnd);
				if (result == null) result = caseElement(parameterConnectionEnd);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.PORT_CONNECTION_END: {
				...
				if (result == null) result = caseConnectionEnd(portConnectionEnd);
				if (result == null) result = caseNamedElement(portConnectionEnd);
				if (result == null) result = caseElement(portConnectionEnd);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Aadl2Package.DATA_SUBCOMPONENT_TYPE: {
				...
				if (result == null) result = caseData(dataSubcomponentType);
				if (result == null) result = caseSubcomponentType(dataSubcomponentType);
				if (result == null) result = caseFeatureClassifier(dataSubcomponentType);
				if (result == null) result = caseType(dataSubcomponentType);
				if (result == null) result = caseNamedElement(dataSubcomponentType);
				if (result == null) result = caseElement(dataSubcomponentType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.DATA_PORT: {
				...
				if (result == null) result = caseContext(dataPort);
				if (result == null) result = caseData(dataPort);
				if (result == null) result = caseParameterConnectionEnd(dataPort);
				if (result == null) result = caseDirectedFeature(dataPort);
				if (result == null) result = casePortConnectionEnd(dataPort);
				if (result == null) result = caseTriggerPort(dataPort);
				if (result == null) result = caseFeature(dataPort);
				if (result == null) result = caseStructuralFeature(dataPort);
				if (result == null) result = caseFeatureConnectionEnd(dataPort);
				if (result == null) result = caseArrayableElement(dataPort);
				if (result == null) result = caseRefinableElement(dataPort);
				if (result == null) result = caseClassifierFeature(dataPort);
				if (result == null) result = caseConnectionEnd(dataPort);
				if (result == null) result = caseNamedElement(dataPort);
				if (result == null) result = caseElement(dataPort);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.PORT: {
				...
				if (result == null) result = caseDirectedFeature(port);
				if (result == null) result = casePortConnectionEnd(port);
				if (result == null) result = caseTriggerPort(port);
				if (result == null) result = caseFeature(port);
				if (result == null) result = caseStructuralFeature(port);
				if (result == null) result = caseFeatureConnectionEnd(port);
				if (result == null) result = caseArrayableElement(port);
				if (result == null) result = caseRefinableElement(port);
				if (result == null) result = caseClassifierFeature(port);
				if (result == null) result = caseConnectionEnd(port);
			...
			case Aadl2Package.EVENT_DATA_PORT: {
				...
				if (result == null) result = caseContext(eventDataPort);
				if (result == null) result = caseData(eventDataPort);
				if (result == null) result = caseParameterConnectionEnd(eventDataPort);
				if (result == null) result = caseDirectedFeature(eventDataPort);
				if (result == null) result = casePortConnectionEnd(eventDataPort);
				if (result == null) result = caseTriggerPort(eventDataPort);
				if (result == null) result = caseFeature(eventDataPort);
				if (result == null) result = caseStructuralFeature(eventDataPort);
				if (result == null) result = caseFeatureConnectionEnd(eventDataPort);
				if (result == null) result = caseArrayableElement(eventDataPort);
				if (result == null) result = caseRefinableElement(eventDataPort);
				if (result == null) result = caseClassifierFeature(eventDataPort);
				if (result == null) result = caseConnectionEnd(eventDataPort);
				if (result == null) result = caseNamedElement(eventDataPort);
				if (result == null) result = caseElement(eventDataPort);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.EVENT_PORT: {
				...
				if (result == null) result = casePortConnectionEnd(eventPort);
				if (result == null) result = caseTriggerPort(eventPort);
				if (result == null) result = caseFeature(eventPort);
				if (result == null) result = caseStructuralFeature(eventPort);
				if (result == null) result = caseFeatureConnectionEnd(eventPort);
				if (result == null) result = caseArrayableElement(eventPort);
				if (result == null) result = caseRefinableElement(eventPort);
				if (result == null) result = caseClassifierFeature(eventPort);
				if (result == null) result = caseConnectionEnd(eventPort);
				if (result == null) result = caseNamedElement(eventPort);
				if (result == null) result = caseElement(eventPort);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Aadl2Package.SUBPROGRAM_ACCESS: {
				...
				if (result == null) result = caseSubprogram(subprogramAccess);
				if (result == null) result = caseFeature(subprogramAccess);
				if (result == null) result = caseAccessConnectionEnd(subprogramAccess);
				if (result == null) result = caseCalledSubprogram(subprogramAccess);
				if (result == null) result = caseStructuralFeature(subprogramAccess);
				if (result == null) result = caseFeatureConnectionEnd(subprogramAccess);
				if (result == null) result = caseArrayableElement(subprogramAccess);
				if (result == null) result = caseRefinableElement(subprogramAccess);
				if (result == null) result = caseClassifierFeature(subprogramAccess);
				if (result == null) result = caseConnectionEnd(subprogramAccess);
				if (result == null) result = caseNamedElement(subprogramAccess);
				if (result == null) result = caseElement(subprogramAccess);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.SUBPROGRAM: {
				...
				if (result == null) result = caseNamedElement(subprogram);
				if (result == null) result = caseCalledSubprogram(subprogram);
				if (result == null) result = caseElement(subprogram);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.SUBPROGRAM_SUBCOMPONENT_TYPE: {
				...
				if (result == null) result = caseSubcomponentType(subprogramSubcomponentType);
				if (result == null) result = caseSubprogram(subprogramSubcomponentType);
				if (result == null) result = caseFeatureClassifier(subprogramSubcomponentType);
				if (result == null) result = caseType(subprogramSubcomponentType);
				if (result == null) result = caseCalledSubprogram(subprogramSubcomponentType);
				if (result == null) result = caseNamedElement(subprogramSubcomponentType);
				if (result == null) result = caseElement(subprogramSubcomponentType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.SUBPROGRAM_GROUP_ACCESS: {
				...
				if (result == null) result = caseSubprogramGroup(subprogramGroupAccess);
				if (result == null) result = caseCallContext(subprogramGroupAccess);
				if (result == null) result = caseFeature(subprogramGroupAccess);
				if (result == null) result = caseAccessConnectionEnd(subprogramGroupAccess);
				if (result == null) result = caseStructuralFeature(subprogramGroupAccess);
				if (result == null) result = caseFeatureConnectionEnd(subprogramGroupAccess);
				if (result == null) result = caseArrayableElement(subprogramGroupAccess);
				if (result == null) result = caseRefinableElement(subprogramGroupAccess);
				if (result == null) result = caseClassifierFeature(subprogramGroupAccess);
				if (result == null) result = caseConnectionEnd(subprogramGroupAccess);
				if (result == null) result = caseNamedElement(subprogramGroupAccess);
				if (result == null) result = caseElement(subprogramGroupAccess);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.SUBPROGRAM_GROUP: {
				...
				if (result == null) result = caseNamedElement(subprogramGroup);
				if (result == null) result = caseElement(subprogramGroup);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.SUBPROGRAM_GROUP_SUBCOMPONENT_TYPE: {
				...
				if (result == null) result = caseSubcomponentType(subprogramGroupSubcomponentType);
				if (result == null) result = caseSubprogramGroup(subprogramGroupSubcomponentType);
				if (result == null) result = caseFeatureClassifier(subprogramGroupSubcomponentType);
				if (result == null) result = caseType(subprogramGroupSubcomponentType);
				if (result == null) result = caseNamedElement(subprogramGroupSubcomponentType);
				if (result == null) result = caseElement(subprogramGroupSubcomponentType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.ABSTRACT_FEATURE: {
				...
				if (result == null) result = caseTriggerPort(abstractFeature);
				if (result == null) result = caseFeature(abstractFeature);
				if (result == null) result = caseStructuralFeature(abstractFeature);
				if (result == null) result = caseFeatureConnectionEnd(abstractFeature);
				if (result == null) result = caseArrayableElement(abstractFeature);
				if (result == null) result = caseRefinableElement(abstractFeature);
				if (result == null) result = caseClassifierFeature(abstractFeature);
				if (result == null) result = caseConnectionEnd(abstractFeature);
				if (result == null) result = caseNamedElement(abstractFeature);
				if (result == null) result = caseElement(abstractFeature);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.FEATURE_PROTOTYPE: {
				...
				if (result == null) result = casePrototype(featurePrototype);
				if (result == null) result = caseStructuralFeature(featurePrototype);
				if (result == null) result = caseCalledSubprogram(featurePrototype);
				if (result == null) result = caseRefinableElement(featurePrototype);
				if (result == null) result = caseClassifierFeature(featurePrototype);
				if (result == null) result = caseNamedElement(featurePrototype);
				if (result == null) result = caseElement(featurePrototype);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.FEATURE_GROUP_PROTOTYPE: {
				...
				if (result == null) result = casePrototype(featureGroupPrototype);
				if (result == null) result = caseFeatureType(featureGroupPrototype);
				if (result == null) result = caseStructuralFeature(featureGroupPrototype);
				if (result == null) result = caseCalledSubprogram(featureGroupPrototype);
				if (result == null) result = caseRefinableElement(featureGroupPrototype);
				if (result == null) result = caseClassifierFeature(featureGroupPrototype);
				if (result == null) result = caseNamedElement(featureGroupPrototype);
				if (result == null) result = caseElement(featureGroupPrototype);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.SUBCOMPONENT: {
				...
				if (result == null) result = caseStructuralFeature(subcomponent);
				if (result == null) result = caseModalElement(subcomponent);
				if (result == null) result = caseContext(subcomponent);
				if (result == null) result = caseFlowElement(subcomponent);
				if (result == null) result = caseArrayableElement(subcomponent);
				if (result == null) result = caseRefinableElement(subcomponent);
				if (result == null) result = caseClassifierFeature(subcomponent);
				if (result == null) result = caseEndToEndFlowElement(subcomponent);
				if (result == null) result = caseNamedElement(subcomponent);
				if (result == null) result = caseElement(subcomponent);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.MODE_BINDING: {
				...
				if (result == null) result = caseElement(modeBinding);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.FLOW_IMPLEMENTATION: {
				...
				if (result == null) result = caseModalPath(flowImplementation);
				if (result == null) result = caseClassifierFeature(flowImplementation);
				if (result == null) result = caseFlow(flowImplementation);
				if (result == null) result = caseModalElement(flowImplementation);
				if (result == null) result = caseNamedElement(flowImplementation);
				if (result == null) result = caseElement(flowImplementation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.FLOW_SEGMENT: {
				...
				if (result == null) result = caseElement(flowSegment);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.CONNECTION: {
				...
				if (result == null) result = caseStructuralFeature(connection);
				if (result == null) result = caseModalPath(connection);
				if (result == null) result = caseFlowElement(connection);
				if (result == null) result = caseRefinableElement(connection);
				if (result == null) result = caseClassifierFeature(connection);
				if (result == null) result = caseModalElement(connection);
				if (result == null) result = caseEndToEndFlowElement(connection);
			...
			case Aadl2Package.CONNECTED_ELEMENT: {
				...
				if (result == null) result = caseElement(connectedElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.IMPLEMENTATION_EXTENSION: {
				...
				if (result == null) result = caseGeneralization(implementationExtension);
				if (result == null) result = caseDirectedRelationship(implementationExtension);
				if (result == null) result = caseRelationship(implementationExtension);
				if (result == null) result = caseElement(implementationExtension);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.REALIZATION: {
				...
				if (result == null) result = caseGeneralization(realization);
			...
			case Aadl2Package.END_TO_END_FLOW: {
				...
				if (result == null) result = caseFlowFeature(endToEndFlow);
				if (result == null) result = caseModalPath(endToEndFlow);
				if (result == null) result = caseEndToEndFlowElement(endToEndFlow);
				if (result == null) result = caseStructuralFeature(endToEndFlow);
				if (result == null) result = caseFlow(endToEndFlow);
				if (result == null) result = caseModalElement(endToEndFlow);
				if (result == null) result = caseRefinableElement(endToEndFlow);
				if (result == null) result = caseClassifierFeature(endToEndFlow);
				if (result == null) result = caseNamedElement(endToEndFlow);
				if (result == null) result = caseElement(endToEndFlow);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.END_TO_END_FLOW_SEGMENT: {
				...
				if (result == null) result = caseElement(endToEndFlowSegment);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.ABSTRACT_SUBCOMPONENT: {
				...
				if (result == null) result = caseSubcomponent(abstractSubcomponent);
				if (result == null) result = caseAbstract(abstractSubcomponent);
				if (result == null) result = caseStructuralFeature(abstractSubcomponent);
				if (result == null) result = caseModalElement(abstractSubcomponent);
				if (result == null) result = caseContext(abstractSubcomponent);
				if (result == null) result = caseFlowElement(abstractSubcomponent);
				if (result == null) result = caseArrayableElement(abstractSubcomponent);
				if (result == null) result = caseRefinableElement(abstractSubcomponent);
				if (result == null) result = caseClassifierFeature(abstractSubcomponent);
				if (result == null) result = caseEndToEndFlowElement(abstractSubcomponent);
				if (result == null) result = caseNamedElement(abstractSubcomponent);
				if (result == null) result = caseElement(abstractSubcomponent);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.ABSTRACT: {
				...
				if (result == null) result = caseNamedElement(abstract_);
				if (result == null) result = caseElement(abstract_);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.ABSTRACT_SUBCOMPONENT_TYPE: {
				...
				if (result == null) result = caseAbstract(abstractSubcomponentType);
				if (result == null) result = caseSubcomponentType(abstractSubcomponentType);
				if (result == null) result = caseType(abstractSubcomponentType);
				if (result == null) result = caseNamedElement(abstractSubcomponentType);
				if (result == null) result = caseElement(abstractSubcomponentType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.ACCESS_CONNECTION: {
				...
				if (result == null) result = caseConnection(accessConnection);
				if (result == null) result = caseStructuralFeature(accessConnection);
				if (result == null) result = caseModalPath(accessConnection);
				if (result == null) result = caseFlowElement(accessConnection);
				if (result == null) result = caseRefinableElement(accessConnection);
				if (result == null) result = caseClassifierFeature(accessConnection);
				if (result == null) result = caseModalElement(accessConnection);
				if (result == null) result = caseEndToEndFlowElement(accessConnection);
				if (result == null) result = caseNamedElement(accessConnection);
				if (result == null) result = caseElement(accessConnection);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.PARAMETER_CONNECTION: {
				...
				if (result == null) result = caseStructuralFeature(parameterConnection);
				if (result == null) result = caseModalPath(parameterConnection);
				if (result == null) result = caseFlowElement(parameterConnection);
				if (result == null) result = caseRefinableElement(parameterConnection);
				if (result == null) result = caseClassifierFeature(parameterConnection);
				if (result == null) result = caseModalElement(parameterConnection);
				if (result == null) result = caseEndToEndFlowElement(parameterConnection);
				if (result == null) result = caseNamedElement(parameterConnection);
				if (result == null) result = caseElement(parameterConnection);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.PORT_CONNECTION: {
				...
				if (result == null) result = caseStructuralFeature(portConnection);
				if (result == null) result = caseModalPath(portConnection);
				if (result == null) result = caseFlowElement(portConnection);
				if (result == null) result = caseRefinableElement(portConnection);
				if (result == null) result = caseClassifierFeature(portConnection);
				if (result == null) result = caseModalElement(portConnection);
				if (result == null) result = caseEndToEndFlowElement(portConnection);
				if (result == null) result = caseNamedElement(portConnection);
				if (result == null) result = caseElement(portConnection);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.FEATURE_CONNECTION: {
				...
				if (result == null) result = caseConnection(featureConnection);
				if (result == null) result = caseStructuralFeature(featureConnection);
				if (result == null) result = caseModalPath(featureConnection);
				if (result == null) result = caseFlowElement(featureConnection);
				if (result == null) result = caseRefinableElement(featureConnection);
				if (result == null) result = caseClassifierFeature(featureConnection);
				if (result == null) result = caseModalElement(featureConnection);
				if (result == null) result = caseEndToEndFlowElement(featureConnection);
				if (result == null) result = caseNamedElement(featureConnection);
				if (result == null) result = caseElement(featureConnection);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.FEATURE_GROUP_CONNECTION: {
				...
				if (result == null) result = caseConnection(featureGroupConnection);
				if (result == null) result = caseStructuralFeature(featureGroupConnection);
				if (result == null) result = caseModalPath(featureGroupConnection);
				if (result == null) result = caseFlowElement(featureGroupConnection);
				if (result == null) result = caseRefinableElement(featureGroupConnection);
				if (result == null) result = caseClassifierFeature(featureGroupConnection);
				if (result == null) result = caseModalElement(featureGroupConnection);
				if (result == null) result = caseEndToEndFlowElement(featureGroupConnection);
				if (result == null) result = caseNamedElement(featureGroupConnection);
				if (result == null) result = caseElement(featureGroupConnection);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.PROCESSOR_FEATURE: {
				...
				if (result == null) result = caseStructuralFeature(processorFeature);
				if (result == null) result = caseModalElement(processorFeature);
				if (result == null) result = caseRefinableElement(processorFeature);
				if (result == null) result = caseClassifierFeature(processorFeature);
				if (result == null) result = caseNamedElement(processorFeature);
				if (result == null) result = caseElement(processorFeature);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.INTERNAL_FEATURE: {
				...
				if (result == null) result = caseStructuralFeature(internalFeature);
				if (result == null) result = caseModalElement(internalFeature);
				if (result == null) result = caseFeatureConnectionEnd(internalFeature);
				if (result == null) result = casePortConnectionEnd(internalFeature);
				if (result == null) result = caseTriggerPort(internalFeature);
				if (result == null) result = caseRefinableElement(internalFeature);
				if (result == null) result = caseClassifierFeature(internalFeature);
				if (result == null) result = caseConnectionEnd(internalFeature);
				if (result == null) result = caseNamedElement(internalFeature);
				if (result == null) result = caseElement(internalFeature);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.EVENT_SOURCE: {
				...
				if (result == null) result = caseInternalFeature(eventSource);
				if (result == null) result = caseStructuralFeature(eventSource);
				if (result == null) result = caseModalElement(eventSource);
				if (result == null) result = caseFeatureConnectionEnd(eventSource);
				if (result == null) result = casePortConnectionEnd(eventSource);
				if (result == null) result = caseTriggerPort(eventSource);
				if (result == null) result = caseRefinableElement(eventSource);
				if (result == null) result = caseClassifierFeature(eventSource);
				if (result == null) result = caseConnectionEnd(eventSource);
				if (result == null) result = caseNamedElement(eventSource);
				if (result == null) result = caseElement(eventSource);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.EVENT_DATA_SOURCE: {
				...
				if (result == null) result = caseInternalFeature(eventDataSource);
				if (result == null) result = caseStructuralFeature(eventDataSource);
				if (result == null) result = caseModalElement(eventDataSource);
				if (result == null) result = caseFeatureConnectionEnd(eventDataSource);
				if (result == null) result = casePortConnectionEnd(eventDataSource);
				if (result == null) result = caseTriggerPort(eventDataSource);
				if (result == null) result = caseRefinableElement(eventDataSource);
				if (result == null) result = caseClassifierFeature(eventDataSource);
				if (result == null) result = caseConnectionEnd(eventDataSource);
				if (result == null) result = caseNamedElement(eventDataSource);
				if (result == null) result = caseElement(eventDataSource);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.DATA_CLASSIFIER: {
				...
				if (result == null) result = caseComponentClassifier(dataClassifier);
				if (result == null) result = caseDataSubcomponentType(dataClassifier);
				if (result == null) result = caseClassifier(dataClassifier);
				if (result == null) result = caseSubcomponentType(dataClassifier);
				if (result == null) result = caseFeatureClassifier(dataClassifier);
				if (result == null) result = caseData(dataClassifier);
				if (result == null) result = caseNamespace(dataClassifier);
				if (result == null) result = caseType(dataClassifier);
				if (result == null) result = caseNamedElement(dataClassifier);
				if (result == null) result = caseElement(dataClassifier);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.PORT_PROXY: {
				...
				if (result == null) result = caseProcessorFeature(portProxy);
				if (result == null) result = caseFeatureConnectionEnd(portProxy);
				if (result == null) result = casePortConnectionEnd(portProxy);
				if (result == null) result = caseTriggerPort(portProxy);
				if (result == null) result = caseStructuralFeature(portProxy);
				if (result == null) result = caseModalElement(portProxy);
				if (result == null) result = caseConnectionEnd(portProxy);
				if (result == null) result = caseRefinableElement(portProxy);
				if (result == null) result = caseClassifierFeature(portProxy);
				if (result == null) result = caseNamedElement(portProxy);
				if (result == null) result = caseElement(portProxy);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.SUBPROGRAM_PROXY: {
				...
				if (result == null) result = caseProcessorFeature(subprogramProxy);
				if (result == null) result = caseAccessConnectionEnd(subprogramProxy);
				if (result == null) result = caseCalledSubprogram(subprogramProxy);
				if (result == null) result = caseStructuralFeature(subprogramProxy);
				if (result == null) result = caseModalElement(subprogramProxy);
				if (result == null) result = caseConnectionEnd(subprogramProxy);
				if (result == null) result = caseRefinableElement(subprogramProxy);
				if (result == null) result = caseClassifierFeature(subprogramProxy);
				if (result == null) result = caseNamedElement(subprogramProxy);
				if (result == null) result = caseElement(subprogramProxy);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.SUBPROGRAM_CLASSIFIER: {
				...
				if (result == null) result = caseComponentClassifier(subprogramClassifier);
				if (result == null) result = caseSubprogramSubcomponentType(subprogramClassifier);
				if (result == null) result = caseClassifier(subprogramClassifier);
				if (result == null) result = caseSubcomponentType(subprogramClassifier);
				if (result == null) result = caseFeatureClassifier(subprogramClassifier);
				if (result == null) result = caseSubprogram(subprogramClassifier);
				if (result == null) result = caseNamespace(subprogramClassifier);
				if (result == null) result = caseType(subprogramClassifier);
				if (result == null) result = caseCalledSubprogram(subprogramClassifier);
				if (result == null) result = caseNamedElement(subprogramClassifier);
				if (result == null) result = caseElement(subprogramClassifier);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Aadl2Package.DEFAULT_ANNEX_LIBRARY: {
				...
				if (result == null) result = caseAnnexLibrary(defaultAnnexLibrary);
				if (result == null) result = caseNamedElement(defaultAnnexLibrary);
				if (result == null) result = caseElement(defaultAnnexLibrary);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.DEFAULT_ANNEX_SUBCLAUSE: {
				...
				if (result == null) result = caseAnnexSubclause(defaultAnnexSubclause);
				if (result == null) result = caseModalElement(defaultAnnexSubclause);
				if (result == null) result = caseNamedElement(defaultAnnexSubclause);
				if (result == null) result = caseElement(defaultAnnexSubclause);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.PUBLIC_PACKAGE_SECTION: {
				...
				if (result == null) result = casePackageSection(publicPackageSection);
				if (result == null) result = caseNamespace(publicPackageSection);
				if (result == null) result = caseNamedElement(publicPackageSection);
				if (result == null) result = caseElement(publicPackageSection);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.PACKAGE_SECTION: {
				...
				if (result == null) result = caseNamespace(packageSection);
				if (result == null) result = caseNamedElement(packageSection);
				if (result == null) result = caseElement(packageSection);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.PACKAGE_RENAME: {
				...
				if (result == null) result = caseNamedElement(packageRename);
				if (result == null) result = caseElement(packageRename);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.PACKAGE: {
				aadl2.Package package_ = (aadl2.Package)theEObject;
				T result = casePackage(package_);
				if (result == null) result = caseModelUnit(package_);
			...
			case Aadl2Package.MODEL_UNIT: {
				...
				if (result == null) result = caseNamedElement(modelUnit);
				if (result == null) result = caseElement(modelUnit);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.PRIVATE_PACKAGE_SECTION: {
				...
				if (result == null) result = casePackageSection(privatePackageSection);
				if (result == null) result = caseNamespace(privatePackageSection);
				if (result == null) result = caseNamedElement(privatePackageSection);
				if (result == null) result = caseElement(privatePackageSection);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.COMPONENT_TYPE_RENAME: {
				...
				if (result == null) result = caseNamedElement(componentTypeRename);
				if (result == null) result = caseElement(componentTypeRename);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.FEATURE_GROUP_TYPE_RENAME: {
				...
				if (result == null) result = caseNamedElement(featureGroupTypeRename);
				if (result == null) result = caseElement(featureGroupTypeRename);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.COMPONENT_PROTOTYPE_BINDING: {
				...
				if (result == null) result = casePrototypeBinding(componentPrototypeBinding);
				if (result == null) result = caseElement(componentPrototypeBinding);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.COMPONENT_PROTOTYPE_ACTUAL: {
				...
				if (result == null) result = caseArrayableElement(componentPrototypeActual);
				if (result == null) result = caseElement(componentPrototypeActual);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.FEATURE_GROUP_PROTOTYPE_BINDING: {
				...
				if (result == null) result = casePrototypeBinding(featureGroupPrototypeBinding);
				if (result == null) result = caseElement(featureGroupPrototypeBinding);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.FEATURE_GROUP_PROTOTYPE_ACTUAL: {
				...
				if (result == null) result = caseFeaturePrototypeActual(featureGroupPrototypeActual);
				if (result == null) result = caseArrayableElement(featureGroupPrototypeActual);
				if (result == null) result = caseElement(featureGroupPrototypeActual);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.FEATURE_PROTOTYPE_ACTUAL: {
				...
				if (result == null) result = caseArrayableElement(featurePrototypeActual);
				if (result == null) result = caseElement(featurePrototypeActual);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.FEATURE_PROTOTYPE_BINDING: {
				...
				if (result == null) result = casePrototypeBinding(featurePrototypeBinding);
				if (result == null) result = caseElement(featurePrototypeBinding);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.ACCESS_SPECIFICATION: {
				...
				if (result == null) result = caseFeaturePrototypeActual(accessSpecification);
				if (result == null) result = caseArrayableElement(accessSpecification);
				if (result == null) result = caseElement(accessSpecification);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.PORT_SPECIFICATION: {
				...
				if (result == null) result = caseFeaturePrototypeActual(portSpecification);
				if (result == null) result = caseArrayableElement(portSpecification);
				if (result == null) result = caseElement(portSpecification);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.FEATURE_PROTOTYPE_REFERENCE: {
				...
				if (result == null) result = caseFeaturePrototypeActual(featurePrototypeReference);
				if (result == null) result = caseArrayableElement(featurePrototypeReference);
				if (result == null) result = caseElement(featurePrototypeReference);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.SUBPROGRAM_CALL_SEQUENCE: {
				...
				if (result == null) result = caseBehavioralFeature(subprogramCallSequence);
				if (result == null) result = caseModalElement(subprogramCallSequence);
				if (result == null) result = caseClassifierFeature(subprogramCallSequence);
				if (result == null) result = caseNamedElement(subprogramCallSequence);
				if (result == null) result = caseElement(subprogramCallSequence);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.SUBPROGRAM_CALL: {
				...
				if (result == null) result = caseBehavioralFeature(subprogramCall);
				if (result == null) result = caseContext(subprogramCall);
				if (result == null) result = caseClassifierFeature(subprogramCall);
				if (result == null) result = caseNamedElement(subprogramCall);
			...
			case Aadl2Package.BEHAVIORED_IMPLEMENTATION: {
				...
				if (result == null) result = caseComponentImplementation(behavioredImplementation);
				if (result == null) result = caseComponentClassifier(behavioredImplementation);
				if (result == null) result = caseClassifier(behavioredImplementation);
				if (result == null) result = caseSubcomponentType(behavioredImplementation);
				if (result == null) result = caseFeatureClassifier(behavioredImplementation);
				if (result == null) result = caseNamespace(behavioredImplementation);
				if (result == null) result = caseType(behavioredImplementation);
				if (result == null) result = caseNamedElement(behavioredImplementation);
				if (result == null) result = caseElement(behavioredImplementation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.ABSTRACT_TYPE: {
				...
				if (result == null) result = caseComponentType(abstractType);
				if (result == null) result = caseAbstractClassifier(abstractType);
				if (result == null) result = caseCallContext(abstractType);
				if (result == null) result = caseComponentClassifier(abstractType);
				if (result == null) result = caseAbstractSubcomponentType(abstractType);
				if (result == null) result = caseBusSubcomponentType(abstractType);
				if (result == null) result = caseDataSubcomponentType(abstractType);
				if (result == null) result = caseDeviceSubcomponentType(abstractType);
				if (result == null) result = caseMemorySubcomponentType(abstractType);
				if (result == null) result = caseProcessorSubcomponentType(abstractType);
				if (result == null) result = caseProcessSubcomponentType(abstractType);
				if (result == null) result = caseSubprogramGroupSubcomponentType(abstractType);
				if (result == null) result = caseSubprogramSubcomponentType(abstractType);
				if (result == null) result = caseSystemSubcomponentType(abstractType);
				if (result == null) result = caseThreadGroupSubcomponentType(abstractType);
				if (result == null) result = caseThreadSubcomponentType(abstractType);
				if (result == null) result = caseVirtualBusSubcomponentType(abstractType);
				if (result == null) result = caseVirtualProcessorSubcomponentType(abstractType);
				if (result == null) result = caseClassifier(abstractType);
				if (result == null) result = caseSubcomponentType(abstractType);
				if (result == null) result = caseFeatureClassifier(abstractType);
				if (result == null) result = caseAbstract(abstractType);
				if (result == null) result = caseBus(abstractType);
				if (result == null) result = caseData(abstractType);
				if (result == null) result = caseDevice(abstractType);
				if (result == null) result = caseMemory(abstractType);
				if (result == null) result = caseProcessor(abstractType);
				if (result == null) result = caseProcess(abstractType);
				if (result == null) result = caseSubprogramGroup(abstractType);
				if (result == null) result = caseSubprogram(abstractType);
				if (result == null) result = caseSystem(abstractType);
				if (result == null) result = caseThreadGroup(abstractType);
				if (result == null) result = caseThread(abstractType);
				if (result == null) result = caseVirtualBus(abstractType);
				if (result == null) result = caseVirtualProcessor(abstractType);
				if (result == null) result = caseNamespace(abstractType);
				if (result == null) result = caseType(abstractType);
				if (result == null) result = caseCalledSubprogram(abstractType);
			...
			case Aadl2Package.ABSTRACT_CLASSIFIER: {
				...
				if (result == null) result = caseComponentClassifier(abstractClassifier);
				if (result == null) result = caseAbstractSubcomponentType(abstractClassifier);
				if (result == null) result = caseBusSubcomponentType(abstractClassifier);
				if (result == null) result = caseDataSubcomponentType(abstractClassifier);
				if (result == null) result = caseDeviceSubcomponentType(abstractClassifier);
				if (result == null) result = caseMemorySubcomponentType(abstractClassifier);
				if (result == null) result = caseProcessorSubcomponentType(abstractClassifier);
				if (result == null) result = caseProcessSubcomponentType(abstractClassifier);
				if (result == null) result = caseSubprogramGroupSubcomponentType(abstractClassifier);
				if (result == null) result = caseSubprogramSubcomponentType(abstractClassifier);
				if (result == null) result = caseSystemSubcomponentType(abstractClassifier);
				if (result == null) result = caseThreadGroupSubcomponentType(abstractClassifier);
				if (result == null) result = caseThreadSubcomponentType(abstractClassifier);
				if (result == null) result = caseVirtualBusSubcomponentType(abstractClassifier);
				if (result == null) result = caseVirtualProcessorSubcomponentType(abstractClassifier);
				if (result == null) result = caseClassifier(abstractClassifier);
				if (result == null) result = caseSubcomponentType(abstractClassifier);
				if (result == null) result = caseFeatureClassifier(abstractClassifier);
				if (result == null) result = caseAbstract(abstractClassifier);
				if (result == null) result = caseBus(abstractClassifier);
				if (result == null) result = caseData(abstractClassifier);
				if (result == null) result = caseDevice(abstractClassifier);
				if (result == null) result = caseMemory(abstractClassifier);
				if (result == null) result = caseProcessor(abstractClassifier);
				if (result == null) result = caseProcess(abstractClassifier);
				if (result == null) result = caseSubprogramGroup(abstractClassifier);
				if (result == null) result = caseSubprogram(abstractClassifier);
				if (result == null) result = caseSystem(abstractClassifier);
				if (result == null) result = caseThreadGroup(abstractClassifier);
				if (result == null) result = caseThread(abstractClassifier);
				if (result == null) result = caseVirtualBus(abstractClassifier);
				if (result == null) result = caseVirtualProcessor(abstractClassifier);
				if (result == null) result = caseNamespace(abstractClassifier);
				if (result == null) result = caseType(abstractClassifier);
				if (result == null) result = caseCalledSubprogram(abstractClassifier);
				if (result == null) result = caseNamedElement(abstractClassifier);
				if (result == null) result = caseElement(abstractClassifier);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.VIRTUAL_PROCESSOR_SUBCOMPONENT_TYPE: {
				...
				if (result == null) result = caseSubcomponentType(virtualProcessorSubcomponentType);
				if (result == null) result = caseVirtualProcessor(virtualProcessorSubcomponentType);
				if (result == null) result = caseType(virtualProcessorSubcomponentType);
				if (result == null) result = caseNamedElement(virtualProcessorSubcomponentType);
				if (result == null) result = caseElement(virtualProcessorSubcomponentType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.VIRTUAL_PROCESSOR: {
				...
				if (result == null) result = caseNamedElement(virtualProcessor);
				if (result == null) result = caseElement(virtualProcessor);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.VIRTUAL_BUS_SUBCOMPONENT_TYPE: {
				...
				if (result == null) result = caseSubcomponentType(virtualBusSubcomponentType);
				if (result == null) result = caseVirtualBus(virtualBusSubcomponentType);
				if (result == null) result = caseType(virtualBusSubcomponentType);
				if (result == null) result = caseNamedElement(virtualBusSubcomponentType);
				if (result == null) result = caseElement(virtualBusSubcomponentType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.VIRTUAL_BUS: {
				...
				if (result == null) result = caseNamedElement(virtualBus);
				if (result == null) result = caseElement(virtualBus);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.THREAD_GROUP_SUBCOMPONENT_TYPE: {
				...
				if (result == null) result = caseSubcomponentType(threadGroupSubcomponentType);
				if (result == null) result = caseThreadGroup(threadGroupSubcomponentType);
				if (result == null) result = caseType(threadGroupSubcomponentType);
				if (result == null) result = caseNamedElement(threadGroupSubcomponentType);
				if (result == null) result = caseElement(threadGroupSubcomponentType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.THREAD_GROUP: {
				aadl2.ThreadGroup threadGroup = (aadl2.ThreadGroup)theEObject;
				T result = caseThreadGroup(threadGroup);
				if (result == null) result = caseNamedElement(threadGroup);
				if (result == null) result = caseElement(threadGroup);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.THREAD_SUBCOMPONENT_TYPE: {
				...
				if (result == null) result = caseSubcomponentType(threadSubcomponentType);
				if (result == null) result = caseThread(threadSubcomponentType);
				if (result == null) result = caseType(threadSubcomponentType);
				if (result == null) result = caseNamedElement(threadSubcomponentType);
				if (result == null) result = caseElement(threadSubcomponentType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.THREAD: {
				aadl2.Thread thread = (aadl2.Thread)theEObject;
			...
			case Aadl2Package.SYSTEM_SUBCOMPONENT_TYPE: {
				...
				if (result == null) result = caseSubcomponentType(systemSubcomponentType);
				if (result == null) result = caseSystem(systemSubcomponentType);
				if (result == null) result = caseType(systemSubcomponentType);
				if (result == null) result = caseNamedElement(systemSubcomponentType);
				if (result == null) result = caseElement(systemSubcomponentType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.SYSTEM: {
				aadl2.System system = (aadl2.System)theEObject;
			...
			case Aadl2Package.PROCESS_SUBCOMPONENT_TYPE: {
				...
				if (result == null) result = caseProcess(processSubcomponentType);
				if (result == null) result = caseSubcomponentType(processSubcomponentType);
				if (result == null) result = caseType(processSubcomponentType);
				if (result == null) result = caseNamedElement(processSubcomponentType);
				if (result == null) result = caseElement(processSubcomponentType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.PROCESS: {
				aadl2.Process process = (aadl2.Process)theEObject;
			...
			case Aadl2Package.MEMORY_SUBCOMPONENT_TYPE: {
				...
				if (result == null) result = caseMemory(memorySubcomponentType);
				if (result == null) result = caseSubcomponentType(memorySubcomponentType);
				if (result == null) result = caseType(memorySubcomponentType);
				if (result == null) result = caseNamedElement(memorySubcomponentType);
				if (result == null) result = caseElement(memorySubcomponentType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.MEMORY: {
				...
				if (result == null) result = caseNamedElement(memory);
				if (result == null) result = caseElement(memory);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.DEVICE_SUBCOMPONENT_TYPE: {
				...
				if (result == null) result = caseDevice(deviceSubcomponentType);
				if (result == null) result = caseSubcomponentType(deviceSubcomponentType);
				if (result == null) result = caseType(deviceSubcomponentType);
				if (result == null) result = caseNamedElement(deviceSubcomponentType);
				if (result == null) result = caseElement(deviceSubcomponentType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Aadl2Package.PROCESSOR_SUBCOMPONENT_TYPE: {
				...
				if (result == null) result = caseProcessor(processorSubcomponentType);
				if (result == null) result = caseSubcomponentType(processorSubcomponentType);
				if (result == null) result = caseType(processorSubcomponentType);
				if (result == null) result = caseNamedElement(processorSubcomponentType);
				if (result == null) result = caseElement(processorSubcomponentType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.PROCESSOR: {
				...
				if (result == null) result = caseElement(processor);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.ABSTRACT_IMPLEMENTATION: {
				...
				if (result == null) result = caseBehavioredImplementation(abstractImplementation);
				if (result == null) result = caseAbstractClassifier(abstractImplementation);
				if (result == null) result = caseComponentImplementation(abstractImplementation);
				if (result == null) result = caseAbstractSubcomponentType(abstractImplementation);
				if (result == null) result = caseBusSubcomponentType(abstractImplementation);
				if (result == null) result = caseDataSubcomponentType(abstractImplementation);
				if (result == null) result = caseDeviceSubcomponentType(abstractImplementation);
				if (result == null) result = caseMemorySubcomponentType(abstractImplementation);
				if (result == null) result = caseProcessorSubcomponentType(abstractImplementation);
				if (result == null) result = caseProcessSubcomponentType(abstractImplementation);
				if (result == null) result = caseSubprogramGroupSubcomponentType(abstractImplementation);
				if (result == null) result = caseSubprogramSubcomponentType(abstractImplementation);
				if (result == null) result = caseSystemSubcomponentType(abstractImplementation);
				if (result == null) result = caseThreadGroupSubcomponentType(abstractImplementation);
				if (result == null) result = caseThreadSubcomponentType(abstractImplementation);
				if (result == null) result = caseVirtualBusSubcomponentType(abstractImplementation);
				if (result == null) result = caseVirtualProcessorSubcomponentType(abstractImplementation);
				if (result == null) result = caseComponentClassifier(abstractImplementation);
				if (result == null) result = caseAbstract(abstractImplementation);
				if (result == null) result = caseBus(abstractImplementation);
				if (result == null) result = caseData(abstractImplementation);
				if (result == null) result = caseDevice(abstractImplementation);
				if (result == null) result = caseMemory(abstractImplementation);
				if (result == null) result = caseProcessor(abstractImplementation);
				if (result == null) result = caseProcess(abstractImplementation);
				if (result == null) result = caseSubprogramGroup(abstractImplementation);
				if (result == null) result = caseSubprogram(abstractImplementation);
				if (result == null) result = caseSystem(abstractImplementation);
				if (result == null) result = caseThreadGroup(abstractImplementation);
				if (result == null) result = caseThread(abstractImplementation);
				if (result == null) result = caseVirtualBus(abstractImplementation);
				if (result == null) result = caseVirtualProcessor(abstractImplementation);
				if (result == null) result = caseClassifier(abstractImplementation);
				if (result == null) result = caseSubcomponentType(abstractImplementation);
				if (result == null) result = caseFeatureClassifier(abstractImplementation);
				if (result == null) result = caseCalledSubprogram(abstractImplementation);
				if (result == null) result = caseNamespace(abstractImplementation);
				if (result == null) result = caseType(abstractImplementation);
				if (result == null) result = caseNamedElement(abstractImplementation);
				if (result == null) result = caseElement(abstractImplementation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.BUS_SUBCOMPONENT: {
				...
				if (result == null) result = caseSubcomponent(busSubcomponent);
				if (result == null) result = caseAccessConnectionEnd(busSubcomponent);
				if (result == null) result = caseBus(busSubcomponent);
				if (result == null) result = caseStructuralFeature(busSubcomponent);
				if (result == null) result = caseModalElement(busSubcomponent);
				if (result == null) result = caseContext(busSubcomponent);
				if (result == null) result = caseFlowElement(busSubcomponent);
				if (result == null) result = caseArrayableElement(busSubcomponent);
				if (result == null) result = caseConnectionEnd(busSubcomponent);
				if (result == null) result = caseRefinableElement(busSubcomponent);
				if (result == null) result = caseClassifierFeature(busSubcomponent);
				if (result == null) result = caseEndToEndFlowElement(busSubcomponent);
				if (result == null) result = caseNamedElement(busSubcomponent);
				if (result == null) result = caseElement(busSubcomponent);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.DATA_SUBCOMPONENT: {
				...
				if (result == null) result = caseSubcomponent(dataSubcomponent);
				if (result == null) result = caseAccessConnectionEnd(dataSubcomponent);
				if (result == null) result = caseData(dataSubcomponent);
				if (result == null) result = caseParameterConnectionEnd(dataSubcomponent);
				if (result == null) result = casePortConnectionEnd(dataSubcomponent);
				if (result == null) result = caseStructuralFeature(dataSubcomponent);
				if (result == null) result = caseModalElement(dataSubcomponent);
				if (result == null) result = caseContext(dataSubcomponent);
				if (result == null) result = caseFlowElement(dataSubcomponent);
				if (result == null) result = caseArrayableElement(dataSubcomponent);
				if (result == null) result = caseConnectionEnd(dataSubcomponent);
				if (result == null) result = caseRefinableElement(dataSubcomponent);
				if (result == null) result = caseClassifierFeature(dataSubcomponent);
				if (result == null) result = caseEndToEndFlowElement(dataSubcomponent);
				if (result == null) result = caseNamedElement(dataSubcomponent);
				if (result == null) result = caseElement(dataSubcomponent);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.DEVICE_SUBCOMPONENT: {
				...
				if (result == null) result = caseSubcomponent(deviceSubcomponent);
				if (result == null) result = caseDevice(deviceSubcomponent);
				if (result == null) result = caseStructuralFeature(deviceSubcomponent);
				if (result == null) result = caseModalElement(deviceSubcomponent);
				if (result == null) result = caseContext(deviceSubcomponent);
				if (result == null) result = caseFlowElement(deviceSubcomponent);
				if (result == null) result = caseArrayableElement(deviceSubcomponent);
				if (result == null) result = caseRefinableElement(deviceSubcomponent);
				if (result == null) result = caseClassifierFeature(deviceSubcomponent);
				if (result == null) result = caseEndToEndFlowElement(deviceSubcomponent);
				if (result == null) result = caseNamedElement(deviceSubcomponent);
				if (result == null) result = caseElement(deviceSubcomponent);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.MEMORY_SUBCOMPONENT: {
				...
				if (result == null) result = caseSubcomponent(memorySubcomponent);
				if (result == null) result = caseMemory(memorySubcomponent);
				if (result == null) result = caseStructuralFeature(memorySubcomponent);
				if (result == null) result = caseModalElement(memorySubcomponent);
				if (result == null) result = caseContext(memorySubcomponent);
				if (result == null) result = caseFlowElement(memorySubcomponent);
				if (result == null) result = caseArrayableElement(memorySubcomponent);
				if (result == null) result = caseRefinableElement(memorySubcomponent);
				if (result == null) result = caseClassifierFeature(memorySubcomponent);
				if (result == null) result = caseEndToEndFlowElement(memorySubcomponent);
				if (result == null) result = caseNamedElement(memorySubcomponent);
				if (result == null) result = caseElement(memorySubcomponent);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.PROCESS_SUBCOMPONENT: {
				...
				if (result == null) result = caseSubcomponent(processSubcomponent);
				if (result == null) result = caseProcess(processSubcomponent);
				if (result == null) result = caseStructuralFeature(processSubcomponent);
				if (result == null) result = caseModalElement(processSubcomponent);
				if (result == null) result = caseContext(processSubcomponent);
				if (result == null) result = caseFlowElement(processSubcomponent);
				if (result == null) result = caseArrayableElement(processSubcomponent);
				if (result == null) result = caseRefinableElement(processSubcomponent);
				if (result == null) result = caseClassifierFeature(processSubcomponent);
				if (result == null) result = caseEndToEndFlowElement(processSubcomponent);
				if (result == null) result = caseNamedElement(processSubcomponent);
				if (result == null) result = caseElement(processSubcomponent);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.PROCESSOR_SUBCOMPONENT: {
				...
				if (result == null) result = caseSubcomponent(processorSubcomponent);
				if (result == null) result = caseProcessor(processorSubcomponent);
				if (result == null) result = caseStructuralFeature(processorSubcomponent);
				if (result == null) result = caseModalElement(processorSubcomponent);
				if (result == null) result = caseContext(processorSubcomponent);
				if (result == null) result = caseFlowElement(processorSubcomponent);
				if (result == null) result = caseArrayableElement(processorSubcomponent);
				if (result == null) result = caseRefinableElement(processorSubcomponent);
				if (result == null) result = caseClassifierFeature(processorSubcomponent);
				if (result == null) result = caseEndToEndFlowElement(processorSubcomponent);
				if (result == null) result = caseNamedElement(processorSubcomponent);
				if (result == null) result = caseElement(processorSubcomponent);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.SYSTEM_SUBCOMPONENT: {
				...
				if (result == null) result = caseSubcomponent(systemSubcomponent);
				if (result == null) result = caseSystem(systemSubcomponent);
				if (result == null) result = caseStructuralFeature(systemSubcomponent);
				if (result == null) result = caseModalElement(systemSubcomponent);
				if (result == null) result = caseContext(systemSubcomponent);
				if (result == null) result = caseFlowElement(systemSubcomponent);
				if (result == null) result = caseArrayableElement(systemSubcomponent);
				if (result == null) result = caseRefinableElement(systemSubcomponent);
				if (result == null) result = caseClassifierFeature(systemSubcomponent);
				if (result == null) result = caseEndToEndFlowElement(systemSubcomponent);
				if (result == null) result = caseNamedElement(systemSubcomponent);
				if (result == null) result = caseElement(systemSubcomponent);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.SUBPROGRAM_SUBCOMPONENT: {
				...
				if (result == null) result = caseSubcomponent(subprogramSubcomponent);
				if (result == null) result = caseAccessConnectionEnd(subprogramSubcomponent);
				if (result == null) result = caseSubprogram(subprogramSubcomponent);
				if (result == null) result = caseStructuralFeature(subprogramSubcomponent);
				if (result == null) result = caseModalElement(subprogramSubcomponent);
				if (result == null) result = caseContext(subprogramSubcomponent);
				if (result == null) result = caseFlowElement(subprogramSubcomponent);
				if (result == null) result = caseArrayableElement(subprogramSubcomponent);
				if (result == null) result = caseConnectionEnd(subprogramSubcomponent);
				if (result == null) result = caseCalledSubprogram(subprogramSubcomponent);
				if (result == null) result = caseRefinableElement(subprogramSubcomponent);
				if (result == null) result = caseClassifierFeature(subprogramSubcomponent);
				if (result == null) result = caseEndToEndFlowElement(subprogramSubcomponent);
				if (result == null) result = caseNamedElement(subprogramSubcomponent);
				if (result == null) result = caseElement(subprogramSubcomponent);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.SUBPROGRAM_GROUP_SUBCOMPONENT: {
				...
				if (result == null) result = caseSubcomponent(subprogramGroupSubcomponent);
				if (result == null) result = caseAccessConnectionEnd(subprogramGroupSubcomponent);
				if (result == null) result = caseSubprogramGroup(subprogramGroupSubcomponent);
				if (result == null) result = caseCallContext(subprogramGroupSubcomponent);
				if (result == null) result = caseStructuralFeature(subprogramGroupSubcomponent);
				if (result == null) result = caseModalElement(subprogramGroupSubcomponent);
				if (result == null) result = caseContext(subprogramGroupSubcomponent);
				if (result == null) result = caseFlowElement(subprogramGroupSubcomponent);
				if (result == null) result = caseArrayableElement(subprogramGroupSubcomponent);
				if (result == null) result = caseConnectionEnd(subprogramGroupSubcomponent);
				if (result == null) result = caseRefinableElement(subprogramGroupSubcomponent);
				if (result == null) result = caseClassifierFeature(subprogramGroupSubcomponent);
				if (result == null) result = caseEndToEndFlowElement(subprogramGroupSubcomponent);
				if (result == null) result = caseNamedElement(subprogramGroupSubcomponent);
				if (result == null) result = caseElement(subprogramGroupSubcomponent);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.THREAD_SUBCOMPONENT: {
				...
				if (result == null) result = caseSubcomponent(threadSubcomponent);
				if (result == null) result = caseThread(threadSubcomponent);
				if (result == null) result = caseStructuralFeature(threadSubcomponent);
				if (result == null) result = caseModalElement(threadSubcomponent);
				if (result == null) result = caseContext(threadSubcomponent);
				if (result == null) result = caseFlowElement(threadSubcomponent);
				if (result == null) result = caseArrayableElement(threadSubcomponent);
				if (result == null) result = caseRefinableElement(threadSubcomponent);
				if (result == null) result = caseClassifierFeature(threadSubcomponent);
				if (result == null) result = caseEndToEndFlowElement(threadSubcomponent);
				if (result == null) result = caseNamedElement(threadSubcomponent);
				if (result == null) result = caseElement(threadSubcomponent);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.THREAD_GROUP_SUBCOMPONENT: {
				...
				if (result == null) result = caseSubcomponent(threadGroupSubcomponent);
				if (result == null) result = caseThreadGroup(threadGroupSubcomponent);
				if (result == null) result = caseStructuralFeature(threadGroupSubcomponent);
				if (result == null) result = caseModalElement(threadGroupSubcomponent);
				if (result == null) result = caseContext(threadGroupSubcomponent);
				if (result == null) result = caseFlowElement(threadGroupSubcomponent);
				if (result == null) result = caseArrayableElement(threadGroupSubcomponent);
				if (result == null) result = caseRefinableElement(threadGroupSubcomponent);
				if (result == null) result = caseClassifierFeature(threadGroupSubcomponent);
				if (result == null) result = caseEndToEndFlowElement(threadGroupSubcomponent);
				if (result == null) result = caseNamedElement(threadGroupSubcomponent);
				if (result == null) result = caseElement(threadGroupSubcomponent);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.VIRTUAL_BUS_SUBCOMPONENT: {
				...
				if (result == null) result = caseSubcomponent(virtualBusSubcomponent);
				if (result == null) result = caseVirtualBus(virtualBusSubcomponent);
				if (result == null) result = caseStructuralFeature(virtualBusSubcomponent);
				if (result == null) result = caseModalElement(virtualBusSubcomponent);
				if (result == null) result = caseContext(virtualBusSubcomponent);
				if (result == null) result = caseFlowElement(virtualBusSubcomponent);
				if (result == null) result = caseArrayableElement(virtualBusSubcomponent);
				if (result == null) result = caseRefinableElement(virtualBusSubcomponent);
				if (result == null) result = caseClassifierFeature(virtualBusSubcomponent);
				if (result == null) result = caseEndToEndFlowElement(virtualBusSubcomponent);
				if (result == null) result = caseNamedElement(virtualBusSubcomponent);
				if (result == null) result = caseElement(virtualBusSubcomponent);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.VIRTUAL_PROCESSOR_SUBCOMPONENT: {
				...
				if (result == null) result = caseSubcomponent(virtualProcessorSubcomponent);
				if (result == null) result = caseVirtualProcessor(virtualProcessorSubcomponent);
				if (result == null) result = caseStructuralFeature(virtualProcessorSubcomponent);
				if (result == null) result = caseModalElement(virtualProcessorSubcomponent);
				if (result == null) result = caseContext(virtualProcessorSubcomponent);
				if (result == null) result = caseFlowElement(virtualProcessorSubcomponent);
				if (result == null) result = caseArrayableElement(virtualProcessorSubcomponent);
				if (result == null) result = caseRefinableElement(virtualProcessorSubcomponent);
				if (result == null) result = caseClassifierFeature(virtualProcessorSubcomponent);
				if (result == null) result = caseEndToEndFlowElement(virtualProcessorSubcomponent);
				if (result == null) result = caseNamedElement(virtualProcessorSubcomponent);
				if (result == null) result = caseElement(virtualProcessorSubcomponent);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.ABSTRACT_PROTOTYPE: {
				...
				if (result == null) result = caseComponentPrototype(abstractPrototype);
				if (result == null) result = caseAbstractSubcomponentType(abstractPrototype);
				if (result == null) result = caseBusSubcomponentType(abstractPrototype);
				if (result == null) result = caseDataSubcomponentType(abstractPrototype);
				if (result == null) result = caseDeviceSubcomponentType(abstractPrototype);
				if (result == null) result = caseMemorySubcomponentType(abstractPrototype);
				if (result == null) result = caseProcessorSubcomponentType(abstractPrototype);
				if (result == null) result = caseProcessSubcomponentType(abstractPrototype);
				if (result == null) result = caseSubprogramGroupSubcomponentType(abstractPrototype);
				if (result == null) result = caseSubprogramSubcomponentType(abstractPrototype);
				if (result == null) result = caseSystemSubcomponentType(abstractPrototype);
				if (result == null) result = caseThreadGroupSubcomponentType(abstractPrototype);
				if (result == null) result = caseThreadSubcomponentType(abstractPrototype);
				if (result == null) result = caseVirtualBusSubcomponentType(abstractPrototype);
				if (result == null) result = caseVirtualProcessorSubcomponentType(abstractPrototype);
				if (result == null) result = casePrototype(abstractPrototype);
				if (result == null) result = caseSubcomponentType(abstractPrototype);
				if (result == null) result = caseFeatureClassifier(abstractPrototype);
				if (result == null) result = caseAbstract(abstractPrototype);
				if (result == null) result = caseBus(abstractPrototype);
				if (result == null) result = caseData(abstractPrototype);
				if (result == null) result = caseDevice(abstractPrototype);
				if (result == null) result = caseMemory(abstractPrototype);
				if (result == null) result = caseProcessor(abstractPrototype);
				if (result == null) result = caseProcess(abstractPrototype);
				if (result == null) result = caseSubprogramGroup(abstractPrototype);
				if (result == null) result = caseSubprogram(abstractPrototype);
				if (result == null) result = caseSystem(abstractPrototype);
				if (result == null) result = caseThreadGroup(abstractPrototype);
				if (result == null) result = caseThread(abstractPrototype);
				if (result == null) result = caseVirtualBus(abstractPrototype);
				if (result == null) result = caseVirtualProcessor(abstractPrototype);
				if (result == null) result = caseStructuralFeature(abstractPrototype);
				if (result == null) result = caseCalledSubprogram(abstractPrototype);
				if (result == null) result = caseType(abstractPrototype);
				if (result == null) result = caseRefinableElement(abstractPrototype);
				if (result == null) result = caseClassifierFeature(abstractPrototype);
				if (result == null) result = caseNamedElement(abstractPrototype);
				if (result == null) result = caseElement(abstractPrototype);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.BUS_CLASSIFIER: {
				...
				if (result == null) result = caseComponentClassifier(busClassifier);
				if (result == null) result = caseBusSubcomponentType(busClassifier);
				if (result == null) result = caseClassifier(busClassifier);
				if (result == null) result = caseSubcomponentType(busClassifier);
				if (result == null) result = caseFeatureClassifier(busClassifier);
				if (result == null) result = caseBus(busClassifier);
				if (result == null) result = caseNamespace(busClassifier);
				if (result == null) result = caseType(busClassifier);
				if (result == null) result = caseNamedElement(busClassifier);
				if (result == null) result = caseElement(busClassifier);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.BUS_TYPE: {
				...
				if (result == null) result = caseBusSubcomponentType(busType);
				if (result == null) result = caseClassifier(busType);
				if (result == null) result = caseSubcomponentType(busType);
				if (result == null) result = caseFeatureClassifier(busType);
				if (result == null) result = caseBus(busType);
				if (result == null) result = caseNamespace(busType);
				if (result == null) result = caseType(busType);
				if (result == null) result = caseNamedElement(busType);
				if (result == null) result = caseElement(busType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.BUS_IMPLEMENTATION: {
				...
				if (result == null) result = caseBusSubcomponentType(busImplementation);
				if (result == null) result = caseClassifier(busImplementation);
				if (result == null) result = caseSubcomponentType(busImplementation);
				if (result == null) result = caseFeatureClassifier(busImplementation);
				if (result == null) result = caseBus(busImplementation);
				if (result == null) result = caseNamespace(busImplementation);
				if (result == null) result = caseType(busImplementation);
				if (result == null) result = caseNamedElement(busImplementation);
				if (result == null) result = caseElement(busImplementation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.BUS_PROTOTYPE: {
				...
				if (result == null) result = caseComponentPrototype(busPrototype);
				if (result == null) result = caseBusSubcomponentType(busPrototype);
				if (result == null) result = casePrototype(busPrototype);
				if (result == null) result = caseSubcomponentType(busPrototype);
				if (result == null) result = caseFeatureClassifier(busPrototype);
				if (result == null) result = caseBus(busPrototype);
				if (result == null) result = caseStructuralFeature(busPrototype);
				if (result == null) result = caseCalledSubprogram(busPrototype);
				if (result == null) result = caseType(busPrototype);
				if (result == null) result = caseRefinableElement(busPrototype);
				if (result == null) result = caseClassifierFeature(busPrototype);
				if (result == null) result = caseNamedElement(busPrototype);
				if (result == null) result = caseElement(busPrototype);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.DATA_TYPE: {
				...
				if (result == null) result = caseCallContext(dataType);
				if (result == null) result = caseComponentClassifier(dataType);
				if (result == null) result = caseDataSubcomponentType(dataType);
				if (result == null) result = caseClassifier(dataType);
				if (result == null) result = caseSubcomponentType(dataType);
				if (result == null) result = caseFeatureClassifier(dataType);
				if (result == null) result = caseData(dataType);
			...
			case Aadl2Package.DATA_IMPLEMENTATION: {
				...
				if (result == null) result = caseDataSubcomponentType(dataImplementation);
				if (result == null) result = caseClassifier(dataImplementation);
				if (result == null) result = caseSubcomponentType(dataImplementation);
				if (result == null) result = caseFeatureClassifier(dataImplementation);
				if (result == null) result = caseData(dataImplementation);
				if (result == null) result = caseNamespace(dataImplementation);
				if (result == null) result = caseType(dataImplementation);
				if (result == null) result = caseNamedElement(dataImplementation);
				if (result == null) result = caseElement(dataImplementation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.DATA_PROTOTYPE: {
				...
				if (result == null) result = caseComponentPrototype(dataPrototype);
				if (result == null) result = caseDataSubcomponentType(dataPrototype);
				if (result == null) result = casePrototype(dataPrototype);
				if (result == null) result = caseSubcomponentType(dataPrototype);
				if (result == null) result = caseFeatureClassifier(dataPrototype);
				if (result == null) result = caseData(dataPrototype);
				if (result == null) result = caseStructuralFeature(dataPrototype);
				if (result == null) result = caseCalledSubprogram(dataPrototype);
				if (result == null) result = caseType(dataPrototype);
				if (result == null) result = caseRefinableElement(dataPrototype);
				if (result == null) result = caseClassifierFeature(dataPrototype);
				if (result == null) result = caseNamedElement(dataPrototype);
				if (result == null) result = caseElement(dataPrototype);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.DEVICE_CLASSIFIER: {
				...
				if (result == null) result = caseComponentClassifier(deviceClassifier);
				if (result == null) result = caseDeviceSubcomponentType(deviceClassifier);
				if (result == null) result = caseClassifier(deviceClassifier);
				if (result == null) result = caseSubcomponentType(deviceClassifier);
				if (result == null) result = caseFeatureClassifier(deviceClassifier);
				if (result == null) result = caseDevice(deviceClassifier);
				if (result == null) result = caseNamespace(deviceClassifier);
				if (result == null) result = caseType(deviceClassifier);
				if (result == null) result = caseNamedElement(deviceClassifier);
				if (result == null) result = caseElement(deviceClassifier);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.DEVICE_TYPE: {
				...
				if (result == null) result = caseDeviceSubcomponentType(deviceType);
				if (result == null) result = caseClassifier(deviceType);
				if (result == null) result = caseSubcomponentType(deviceType);
				if (result == null) result = caseFeatureClassifier(deviceType);
				if (result == null) result = caseDevice(deviceType);
				if (result == null) result = caseNamespace(deviceType);
				if (result == null) result = caseType(deviceType);
				if (result == null) result = caseNamedElement(deviceType);
			...
			case Aadl2Package.DEVICE_IMPLEMENTATION: {
				...
				if (result == null) result = caseDeviceSubcomponentType(deviceImplementation);
				if (result == null) result = caseClassifier(deviceImplementation);
				if (result == null) result = caseSubcomponentType(deviceImplementation);
				if (result == null) result = caseFeatureClassifier(deviceImplementation);
				if (result == null) result = caseDevice(deviceImplementation);
				if (result == null) result = caseNamespace(deviceImplementation);
				if (result == null) result = caseType(deviceImplementation);
				if (result == null) result = caseNamedElement(deviceImplementation);
				if (result == null) result = caseElement(deviceImplementation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.DEVICE_PROTOTYPE: {
				...
				if (result == null) result = caseComponentPrototype(devicePrototype);
				if (result == null) result = caseDeviceSubcomponentType(devicePrototype);
				if (result == null) result = casePrototype(devicePrototype);
				if (result == null) result = caseSubcomponentType(devicePrototype);
				if (result == null) result = caseFeatureClassifier(devicePrototype);
				if (result == null) result = caseDevice(devicePrototype);
				if (result == null) result = caseStructuralFeature(devicePrototype);
				if (result == null) result = caseCalledSubprogram(devicePrototype);
				if (result == null) result = caseType(devicePrototype);
				if (result == null) result = caseRefinableElement(devicePrototype);
				if (result == null) result = caseClassifierFeature(devicePrototype);
				if (result == null) result = caseNamedElement(devicePrototype);
				if (result == null) result = caseElement(devicePrototype);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.MEMORY_CLASSIFIER: {
				...
				if (result == null) result = caseComponentClassifier(memoryClassifier);
				if (result == null) result = caseMemorySubcomponentType(memoryClassifier);
				if (result == null) result = caseClassifier(memoryClassifier);
				if (result == null) result = caseSubcomponentType(memoryClassifier);
				if (result == null) result = caseFeatureClassifier(memoryClassifier);
				if (result == null) result = caseMemory(memoryClassifier);
				if (result == null) result = caseNamespace(memoryClassifier);
				if (result == null) result = caseType(memoryClassifier);
				if (result == null) result = caseNamedElement(memoryClassifier);
				if (result == null) result = caseElement(memoryClassifier);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.MEMORY_TYPE: {
				...
				if (result == null) result = caseMemorySubcomponentType(memoryType);
				if (result == null) result = caseClassifier(memoryType);
				if (result == null) result = caseSubcomponentType(memoryType);
				if (result == null) result = caseFeatureClassifier(memoryType);
				if (result == null) result = caseMemory(memoryType);
				if (result == null) result = caseNamespace(memoryType);
				if (result == null) result = caseType(memoryType);
				if (result == null) result = caseNamedElement(memoryType);
				if (result == null) result = caseElement(memoryType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.MEMORY_IMPLEMENTATION: {
				...
				if (result == null) result = caseMemorySubcomponentType(memoryImplementation);
				if (result == null) result = caseClassifier(memoryImplementation);
				if (result == null) result = caseSubcomponentType(memoryImplementation);
				if (result == null) result = caseFeatureClassifier(memoryImplementation);
				if (result == null) result = caseMemory(memoryImplementation);
				if (result == null) result = caseNamespace(memoryImplementation);
				if (result == null) result = caseType(memoryImplementation);
				if (result == null) result = caseNamedElement(memoryImplementation);
				if (result == null) result = caseElement(memoryImplementation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.MEMORY_PROTOTYPE: {
				...
				if (result == null) result = caseComponentPrototype(memoryPrototype);
				if (result == null) result = caseMemorySubcomponentType(memoryPrototype);
				if (result == null) result = casePrototype(memoryPrototype);
				if (result == null) result = caseSubcomponentType(memoryPrototype);
				if (result == null) result = caseFeatureClassifier(memoryPrototype);
				if (result == null) result = caseMemory(memoryPrototype);
				if (result == null) result = caseStructuralFeature(memoryPrototype);
				if (result == null) result = caseCalledSubprogram(memoryPrototype);
				if (result == null) result = caseType(memoryPrototype);
				if (result == null) result = caseRefinableElement(memoryPrototype);
				if (result == null) result = caseClassifierFeature(memoryPrototype);
				if (result == null) result = caseNamedElement(memoryPrototype);
				if (result == null) result = caseElement(memoryPrototype);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.SUBPROGRAM_TYPE: {
				...
				if (result == null) result = caseCallContext(subprogramType);
				if (result == null) result = caseComponentClassifier(subprogramType);
				if (result == null) result = caseSubprogramSubcomponentType(subprogramType);
				if (result == null) result = caseClassifier(subprogramType);
				if (result == null) result = caseSubcomponentType(subprogramType);
				if (result == null) result = caseFeatureClassifier(subprogramType);
				if (result == null) result = caseSubprogram(subprogramType);
				if (result == null) result = caseNamespace(subprogramType);
				if (result == null) result = caseType(subprogramType);
				if (result == null) result = caseCalledSubprogram(subprogramType);
				if (result == null) result = caseNamedElement(subprogramType);
				if (result == null) result = caseElement(subprogramType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.SUBPROGRAM_IMPLEMENTATION: {
				...
				if (result == null) result = caseBehavioredImplementation(subprogramImplementation);
				...
				if (result == null) result = caseSubprogramSubcomponentType(subprogramImplementation);
				if (result == null) result = caseComponentClassifier(subprogramImplementation);
				if (result == null) result = caseSubprogram(subprogramImplementation);
				if (result == null) result = caseClassifier(subprogramImplementation);
				if (result == null) result = caseSubcomponentType(subprogramImplementation);
				if (result == null) result = caseFeatureClassifier(subprogramImplementation);
				if (result == null) result = caseCalledSubprogram(subprogramImplementation);
				if (result == null) result = caseNamespace(subprogramImplementation);
				if (result == null) result = caseType(subprogramImplementation);
				if (result == null) result = caseNamedElement(subprogramImplementation);
				if (result == null) result = caseElement(subprogramImplementation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.SUBPROGRAM_PROTOTYPE: {
				...
				if (result == null) result = caseComponentPrototype(subprogramPrototype);
				if (result == null) result = caseSubprogramSubcomponentType(subprogramPrototype);
				if (result == null) result = casePrototype(subprogramPrototype);
				if (result == null) result = caseSubcomponentType(subprogramPrototype);
				if (result == null) result = caseFeatureClassifier(subprogramPrototype);
				if (result == null) result = caseSubprogram(subprogramPrototype);
				if (result == null) result = caseStructuralFeature(subprogramPrototype);
				if (result == null) result = caseCalledSubprogram(subprogramPrototype);
				if (result == null) result = caseType(subprogramPrototype);
				if (result == null) result = caseRefinableElement(subprogramPrototype);
				if (result == null) result = caseClassifierFeature(subprogramPrototype);
				if (result == null) result = caseNamedElement(subprogramPrototype);
				if (result == null) result = caseElement(subprogramPrototype);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.SUBPROGRAM_GROUP_CLASSIFIER: {
				...
				if (result == null) result = caseComponentClassifier(subprogramGroupClassifier);
				if (result == null) result = caseSubprogramGroupSubcomponentType(subprogramGroupClassifier);
				if (result == null) result = caseClassifier(subprogramGroupClassifier);
				if (result == null) result = caseSubcomponentType(subprogramGroupClassifier);
				if (result == null) result = caseFeatureClassifier(subprogramGroupClassifier);
				if (result == null) result = caseSubprogramGroup(subprogramGroupClassifier);
				if (result == null) result = caseNamespace(subprogramGroupClassifier);
				if (result == null) result = caseType(subprogramGroupClassifier);
				if (result == null) result = caseNamedElement(subprogramGroupClassifier);
				if (result == null) result = caseElement(subprogramGroupClassifier);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.SUBPROGRAM_GROUP_TYPE: {
				...
				if (result == null) result = caseComponentType(subprogramGroupType);
				if (result == null) result = caseSubprogramGroupClassifier(subprogramGroupType);
				if (result == null) result = caseCallContext(subprogramGroupType);
				if (result == null) result = caseComponentClassifier(subprogramGroupType);
				if (result == null) result = caseSubprogramGroupSubcomponentType(subprogramGroupType);
				if (result == null) result = caseClassifier(subprogramGroupType);
				if (result == null) result = caseSubcomponentType(subprogramGroupType);
				if (result == null) result = caseFeatureClassifier(subprogramGroupType);
				if (result == null) result = caseSubprogramGroup(subprogramGroupType);
				if (result == null) result = caseNamespace(subprogramGroupType);
				if (result == null) result = caseType(subprogramGroupType);
				if (result == null) result = caseNamedElement(subprogramGroupType);
				if (result == null) result = caseElement(subprogramGroupType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.SUBPROGRAM_GROUP_IMPLEMENTATION: {
				...
				if (result == null) result = caseComponentImplementation(subprogramGroupImplementation);
				if (result == null) result = caseSubprogramGroupClassifier(subprogramGroupImplementation);
				if (result == null) result = caseComponentClassifier(subprogramGroupImplementation);
				if (result == null) result = caseSubprogramGroupSubcomponentType(subprogramGroupImplementation);
				if (result == null) result = caseClassifier(subprogramGroupImplementation);
				if (result == null) result = caseSubcomponentType(subprogramGroupImplementation);
				if (result == null) result = caseFeatureClassifier(subprogramGroupImplementation);
				if (result == null) result = caseSubprogramGroup(subprogramGroupImplementation);
				if (result == null) result = caseNamespace(subprogramGroupImplementation);
				if (result == null) result = caseType(subprogramGroupImplementation);
				if (result == null) result = caseNamedElement(subprogramGroupImplementation);
				if (result == null) result = caseElement(subprogramGroupImplementation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.SUBPROGRAM_GROUP_PROTOTYPE: {
				...
				if (result == null) result = caseComponentPrototype(subprogramGroupPrototype);
				if (result == null) result = caseSubprogramGroupSubcomponentType(subprogramGroupPrototype);
				if (result == null) result = casePrototype(subprogramGroupPrototype);
				if (result == null) result = caseSubcomponentType(subprogramGroupPrototype);
				if (result == null) result = caseFeatureClassifier(subprogramGroupPrototype);
				if (result == null) result = caseSubprogramGroup(subprogramGroupPrototype);
				if (result == null) result = caseStructuralFeature(subprogramGroupPrototype);
				if (result == null) result = caseCalledSubprogram(subprogramGroupPrototype);
				if (result == null) result = caseType(subprogramGroupPrototype);
				if (result == null) result = caseRefinableElement(subprogramGroupPrototype);
				if (result == null) result = caseClassifierFeature(subprogramGroupPrototype);
				if (result == null) result = caseNamedElement(subprogramGroupPrototype);
				if (result == null) result = caseElement(subprogramGroupPrototype);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.SYSTEM_CLASSIFIER: {
				...
				if (result == null) result = caseComponentClassifier(systemClassifier);
				if (result == null) result = caseSystemSubcomponentType(systemClassifier);
				if (result == null) result = caseClassifier(systemClassifier);
				if (result == null) result = caseSubcomponentType(systemClassifier);
				if (result == null) result = caseFeatureClassifier(systemClassifier);
				if (result == null) result = caseSystem(systemClassifier);
				if (result == null) result = caseNamespace(systemClassifier);
				if (result == null) result = caseType(systemClassifier);
				if (result == null) result = caseNamedElement(systemClassifier);
				if (result == null) result = caseElement(systemClassifier);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.SYSTEM_TYPE: {
				...
				if (result == null) result = caseSystemSubcomponentType(systemType);
				if (result == null) result = caseClassifier(systemType);
				if (result == null) result = caseSubcomponentType(systemType);
				if (result == null) result = caseFeatureClassifier(systemType);
				if (result == null) result = caseSystem(systemType);
				if (result == null) result = caseNamespace(systemType);
				if (result == null) result = caseType(systemType);
				if (result == null) result = caseNamedElement(systemType);
				if (result == null) result = caseElement(systemType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.SYSTEM_IMPLEMENTATION: {
				...
				if (result == null) result = caseSystemSubcomponentType(systemImplementation);
				if (result == null) result = caseClassifier(systemImplementation);
				if (result == null) result = caseSubcomponentType(systemImplementation);
				if (result == null) result = caseFeatureClassifier(systemImplementation);
				if (result == null) result = caseSystem(systemImplementation);
				if (result == null) result = caseNamespace(systemImplementation);
				if (result == null) result = caseType(systemImplementation);
				if (result == null) result = caseNamedElement(systemImplementation);
				if (result == null) result = caseElement(systemImplementation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.SYSTEM_PROTOTYPE: {
				...
				if (result == null) result = caseComponentPrototype(systemPrototype);
				if (result == null) result = caseSystemSubcomponentType(systemPrototype);
				if (result == null) result = casePrototype(systemPrototype);
				if (result == null) result = caseSubcomponentType(systemPrototype);
				if (result == null) result = caseFeatureClassifier(systemPrototype);
				if (result == null) result = caseSystem(systemPrototype);
				if (result == null) result = caseStructuralFeature(systemPrototype);
				if (result == null) result = caseCalledSubprogram(systemPrototype);
				if (result == null) result = caseType(systemPrototype);
				if (result == null) result = caseRefinableElement(systemPrototype);
				if (result == null) result = caseClassifierFeature(systemPrototype);
				if (result == null) result = caseNamedElement(systemPrototype);
				if (result == null) result = caseElement(systemPrototype);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.PROCESSOR_CLASSIFIER: {
				...
				if (result == null) result = caseComponentClassifier(processorClassifier);
				if (result == null) result = caseProcessorSubcomponentType(processorClassifier);
				if (result == null) result = caseClassifier(processorClassifier);
				if (result == null) result = caseSubcomponentType(processorClassifier);
				if (result == null) result = caseFeatureClassifier(processorClassifier);
				if (result == null) result = caseProcessor(processorClassifier);
				if (result == null) result = caseNamespace(processorClassifier);
				if (result == null) result = caseType(processorClassifier);
				if (result == null) result = caseNamedElement(processorClassifier);
				if (result == null) result = caseElement(processorClassifier);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.PROCESSOR_TYPE: {
				...
				if (result == null) result = caseProcessorSubcomponentType(processorType);
				if (result == null) result = caseClassifier(processorType);
				if (result == null) result = caseSubcomponentType(processorType);
				if (result == null) result = caseFeatureClassifier(processorType);
				if (result == null) result = caseProcessor(processorType);
				if (result == null) result = caseNamespace(processorType);
				if (result == null) result = caseType(processorType);
				if (result == null) result = caseNamedElement(processorType);
				if (result == null) result = caseElement(processorType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.PROCESSOR_IMPLEMENTATION: {
				...
				if (result == null) result = caseProcessorSubcomponentType(processorImplementation);
				if (result == null) result = caseClassifier(processorImplementation);
				if (result == null) result = caseSubcomponentType(processorImplementation);
				if (result == null) result = caseFeatureClassifier(processorImplementation);
				if (result == null) result = caseProcessor(processorImplementation);
				if (result == null) result = caseNamespace(processorImplementation);
				if (result == null) result = caseType(processorImplementation);
				if (result == null) result = caseNamedElement(processorImplementation);
				if (result == null) result = caseElement(processorImplementation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.PROCESSOR_PROTOTYPE: {
				...
				if (result == null) result = caseComponentPrototype(processorPrototype);
				if (result == null) result = caseProcessorSubcomponentType(processorPrototype);
				if (result == null) result = casePrototype(processorPrototype);
				if (result == null) result = caseSubcomponentType(processorPrototype);
				if (result == null) result = caseFeatureClassifier(processorPrototype);
				if (result == null) result = caseProcessor(processorPrototype);
				if (result == null) result = caseStructuralFeature(processorPrototype);
				if (result == null) result = caseCalledSubprogram(processorPrototype);
				if (result == null) result = caseType(processorPrototype);
				if (result == null) result = caseRefinableElement(processorPrototype);
				if (result == null) result = caseClassifierFeature(processorPrototype);
				if (result == null) result = caseNamedElement(processorPrototype);
				if (result == null) result = caseElement(processorPrototype);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.PROCESS_CLASSIFIER: {
				...
				if (result == null) result = caseComponentClassifier(processClassifier);
				if (result == null) result = caseProcessSubcomponentType(processClassifier);
				if (result == null) result = caseClassifier(processClassifier);
				if (result == null) result = caseSubcomponentType(processClassifier);
				if (result == null) result = caseFeatureClassifier(processClassifier);
				if (result == null) result = caseProcess(processClassifier);
				if (result == null) result = caseNamespace(processClassifier);
				if (result == null) result = caseType(processClassifier);
				if (result == null) result = caseNamedElement(processClassifier);
				if (result == null) result = caseElement(processClassifier);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.PROCESS_TYPE: {
				...
				if (result == null) result = caseProcessSubcomponentType(processType);
				if (result == null) result = caseClassifier(processType);
				if (result == null) result = caseSubcomponentType(processType);
				if (result == null) result = caseFeatureClassifier(processType);
				if (result == null) result = caseProcess(processType);
				if (result == null) result = caseNamespace(processType);
				if (result == null) result = caseType(processType);
				if (result == null) result = caseNamedElement(processType);
				if (result == null) result = caseElement(processType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.PROCESS_IMPLEMENTATION: {
				...
				if (result == null) result = caseProcessSubcomponentType(processImplementation);
				if (result == null) result = caseClassifier(processImplementation);
				if (result == null) result = caseSubcomponentType(processImplementation);
				if (result == null) result = caseFeatureClassifier(processImplementation);
				if (result == null) result = caseProcess(processImplementation);
				if (result == null) result = caseNamespace(processImplementation);
				if (result == null) result = caseType(processImplementation);
				if (result == null) result = caseNamedElement(processImplementation);
				if (result == null) result = caseElement(processImplementation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.PROCESS_PROTOTYPE: {
				...
				if (result == null) result = caseComponentPrototype(processPrototype);
				if (result == null) result = caseProcessSubcomponentType(processPrototype);
				if (result == null) result = casePrototype(processPrototype);
				if (result == null) result = caseSubcomponentType(processPrototype);
				if (result == null) result = caseFeatureClassifier(processPrototype);
				if (result == null) result = caseProcess(processPrototype);
				if (result == null) result = caseStructuralFeature(processPrototype);
				if (result == null) result = caseCalledSubprogram(processPrototype);
				if (result == null) result = caseType(processPrototype);
				if (result == null) result = caseRefinableElement(processPrototype);
				if (result == null) result = caseClassifierFeature(processPrototype);
				if (result == null) result = caseNamedElement(processPrototype);
				if (result == null) result = caseElement(processPrototype);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.THREAD_CLASSIFIER: {
				...
				if (result == null) result = caseComponentClassifier(threadClassifier);
				if (result == null) result = caseThreadSubcomponentType(threadClassifier);
				if (result == null) result = caseClassifier(threadClassifier);
				if (result == null) result = caseSubcomponentType(threadClassifier);
				if (result == null) result = caseFeatureClassifier(threadClassifier);
				if (result == null) result = caseThread(threadClassifier);
				if (result == null) result = caseNamespace(threadClassifier);
				if (result == null) result = caseType(threadClassifier);
				if (result == null) result = caseNamedElement(threadClassifier);
				if (result == null) result = caseElement(threadClassifier);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.THREAD_TYPE: {
				...
				if (result == null) result = caseThreadSubcomponentType(threadType);
				if (result == null) result = caseClassifier(threadType);
				if (result == null) result = caseSubcomponentType(threadType);
				if (result == null) result = caseFeatureClassifier(threadType);
				if (result == null) result = caseThread(threadType);
				if (result == null) result = caseNamespace(threadType);
				if (result == null) result = caseType(threadType);
				if (result == null) result = caseNamedElement(threadType);
				if (result == null) result = caseElement(threadType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.THREAD_IMPLEMENTATION: {
				...
				if (result == null) result = caseBehavioredImplementation(threadImplementation);
				...
				if (result == null) result = caseThreadSubcomponentType(threadImplementation);
				if (result == null) result = caseComponentClassifier(threadImplementation);
				if (result == null) result = caseThread(threadImplementation);
				if (result == null) result = caseClassifier(threadImplementation);
				if (result == null) result = caseSubcomponentType(threadImplementation);
				if (result == null) result = caseFeatureClassifier(threadImplementation);
				if (result == null) result = caseNamespace(threadImplementation);
				if (result == null) result = caseType(threadImplementation);
				if (result == null) result = caseNamedElement(threadImplementation);
				if (result == null) result = caseElement(threadImplementation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.THREAD_PROTOTYPE: {
				...
				if (result == null) result = caseComponentPrototype(threadPrototype);
				if (result == null) result = caseThreadSubcomponentType(threadPrototype);
				if (result == null) result = casePrototype(threadPrototype);
				if (result == null) result = caseSubcomponentType(threadPrototype);
				if (result == null) result = caseFeatureClassifier(threadPrototype);
				if (result == null) result = caseThread(threadPrototype);
				if (result == null) result = caseStructuralFeature(threadPrototype);
				if (result == null) result = caseCalledSubprogram(threadPrototype);
				if (result == null) result = caseType(threadPrototype);
				if (result == null) result = caseRefinableElement(threadPrototype);
				if (result == null) result = caseClassifierFeature(threadPrototype);
				if (result == null) result = caseNamedElement(threadPrototype);
				if (result == null) result = caseElement(threadPrototype);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.THREAD_GROUP_CLASSIFIER: {
				...
				if (result == null) result = caseComponentClassifier(threadGroupClassifier);
				if (result == null) result = caseThreadGroupSubcomponentType(threadGroupClassifier);
				if (result == null) result = caseClassifier(threadGroupClassifier);
				if (result == null) result = caseSubcomponentType(threadGroupClassifier);
				if (result == null) result = caseFeatureClassifier(threadGroupClassifier);
				if (result == null) result = caseThreadGroup(threadGroupClassifier);
				if (result == null) result = caseNamespace(threadGroupClassifier);
				if (result == null) result = caseType(threadGroupClassifier);
				if (result == null) result = caseNamedElement(threadGroupClassifier);
				if (result == null) result = caseElement(threadGroupClassifier);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.THREAD_GROUP_TYPE: {
				...
				if (result == null) result = caseComponentType(threadGroupType);
				if (result == null) result = caseThreadGroupClassifier(threadGroupType);
				if (result == null) result = caseComponentClassifier(threadGroupType);
				if (result == null) result = caseThreadGroupSubcomponentType(threadGroupType);
				if (result == null) result = caseClassifier(threadGroupType);
				if (result == null) result = caseSubcomponentType(threadGroupType);
				if (result == null) result = caseFeatureClassifier(threadGroupType);
				if (result == null) result = caseThreadGroup(threadGroupType);
				if (result == null) result = caseNamespace(threadGroupType);
				if (result == null) result = caseType(threadGroupType);
				if (result == null) result = caseNamedElement(threadGroupType);
				if (result == null) result = caseElement(threadGroupType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.THREAD_GROUP_IMPLEMENTATION: {
				...
				if (result == null) result = caseComponentImplementation(threadGroupImplementation);
				if (result == null) result = caseThreadGroupClassifier(threadGroupImplementation);
				if (result == null) result = caseComponentClassifier(threadGroupImplementation);
				if (result == null) result = caseThreadGroupSubcomponentType(threadGroupImplementation);
				if (result == null) result = caseClassifier(threadGroupImplementation);
				if (result == null) result = caseSubcomponentType(threadGroupImplementation);
				if (result == null) result = caseFeatureClassifier(threadGroupImplementation);
				if (result == null) result = caseThreadGroup(threadGroupImplementation);
				if (result == null) result = caseNamespace(threadGroupImplementation);
				if (result == null) result = caseType(threadGroupImplementation);
				if (result == null) result = caseNamedElement(threadGroupImplementation);
				if (result == null) result = caseElement(threadGroupImplementation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.THREAD_GROUP_PROTOTYPE: {
				...
				if (result == null) result = caseComponentPrototype(threadGroupPrototype);
				if (result == null) result = caseThreadGroupSubcomponentType(threadGroupPrototype);
				if (result == null) result = casePrototype(threadGroupPrototype);
				if (result == null) result = caseSubcomponentType(threadGroupPrototype);
				if (result == null) result = caseFeatureClassifier(threadGroupPrototype);
				if (result == null) result = caseThreadGroup(threadGroupPrototype);
				if (result == null) result = caseStructuralFeature(threadGroupPrototype);
				if (result == null) result = caseCalledSubprogram(threadGroupPrototype);
				if (result == null) result = caseType(threadGroupPrototype);
				if (result == null) result = caseRefinableElement(threadGroupPrototype);
				if (result == null) result = caseClassifierFeature(threadGroupPrototype);
				if (result == null) result = caseNamedElement(threadGroupPrototype);
				if (result == null) result = caseElement(threadGroupPrototype);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.VIRTUAL_BUS_CLASSIFIER: {
				...
				if (result == null) result = caseComponentClassifier(virtualBusClassifier);
				if (result == null) result = caseVirtualBusSubcomponentType(virtualBusClassifier);
				if (result == null) result = caseClassifier(virtualBusClassifier);
				if (result == null) result = caseSubcomponentType(virtualBusClassifier);
				if (result == null) result = caseFeatureClassifier(virtualBusClassifier);
				if (result == null) result = caseVirtualBus(virtualBusClassifier);
				if (result == null) result = caseNamespace(virtualBusClassifier);
				if (result == null) result = caseType(virtualBusClassifier);
				if (result == null) result = caseNamedElement(virtualBusClassifier);
				if (result == null) result = caseElement(virtualBusClassifier);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.VIRTUAL_BUS_TYPE: {
				...
				if (result == null) result = caseComponentType(virtualBusType);
				if (result == null) result = caseVirtualBusClassifier(virtualBusType);
				if (result == null) result = caseComponentClassifier(virtualBusType);
				if (result == null) result = caseVirtualBusSubcomponentType(virtualBusType);
				if (result == null) result = caseClassifier(virtualBusType);
				if (result == null) result = caseSubcomponentType(virtualBusType);
				if (result == null) result = caseFeatureClassifier(virtualBusType);
				if (result == null) result = caseVirtualBus(virtualBusType);
				if (result == null) result = caseNamespace(virtualBusType);
				if (result == null) result = caseType(virtualBusType);
				if (result == null) result = caseNamedElement(virtualBusType);
				if (result == null) result = caseElement(virtualBusType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.VIRTUAL_BUS_IMPLEMENTATION: {
				...
				if (result == null) result = caseComponentImplementation(virtualBusImplementation);
				if (result == null) result = caseVirtualBusClassifier(virtualBusImplementation);
				if (result == null) result = caseComponentClassifier(virtualBusImplementation);
				if (result == null) result = caseVirtualBusSubcomponentType(virtualBusImplementation);
				if (result == null) result = caseClassifier(virtualBusImplementation);
				if (result == null) result = caseSubcomponentType(virtualBusImplementation);
				if (result == null) result = caseFeatureClassifier(virtualBusImplementation);
				if (result == null) result = caseVirtualBus(virtualBusImplementation);
				if (result == null) result = caseNamespace(virtualBusImplementation);
				if (result == null) result = caseType(virtualBusImplementation);
				if (result == null) result = caseNamedElement(virtualBusImplementation);
				if (result == null) result = caseElement(virtualBusImplementation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.VIRTUAL_BUS_PROTOTYPE: {
				...
				if (result == null) result = caseComponentPrototype(virtualBusPrototype);
				if (result == null) result = caseVirtualBusSubcomponentType(virtualBusPrototype);
				if (result == null) result = casePrototype(virtualBusPrototype);
				if (result == null) result = caseSubcomponentType(virtualBusPrototype);
				if (result == null) result = caseFeatureClassifier(virtualBusPrototype);
				if (result == null) result = caseVirtualBus(virtualBusPrototype);
				if (result == null) result = caseStructuralFeature(virtualBusPrototype);
				if (result == null) result = caseCalledSubprogram(virtualBusPrototype);
				if (result == null) result = caseType(virtualBusPrototype);
				if (result == null) result = caseRefinableElement(virtualBusPrototype);
				if (result == null) result = caseClassifierFeature(virtualBusPrototype);
				if (result == null) result = caseNamedElement(virtualBusPrototype);
				if (result == null) result = caseElement(virtualBusPrototype);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.VIRTUAL_PROCESSOR_CLASSIFIER: {
				...
				if (result == null) result = caseComponentClassifier(virtualProcessorClassifier);
				if (result == null) result = caseVirtualProcessorSubcomponentType(virtualProcessorClassifier);
				if (result == null) result = caseClassifier(virtualProcessorClassifier);
				if (result == null) result = caseSubcomponentType(virtualProcessorClassifier);
				if (result == null) result = caseFeatureClassifier(virtualProcessorClassifier);
				if (result == null) result = caseVirtualProcessor(virtualProcessorClassifier);
				if (result == null) result = caseNamespace(virtualProcessorClassifier);
				if (result == null) result = caseType(virtualProcessorClassifier);
				if (result == null) result = caseNamedElement(virtualProcessorClassifier);
				if (result == null) result = caseElement(virtualProcessorClassifier);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.VIRTUAL_PROCESSOR_TYPE: {
				...
				if (result == null) result = caseComponentType(virtualProcessorType);
				if (result == null) result = caseVirtualProcessorClassifier(virtualProcessorType);
				if (result == null) result = caseComponentClassifier(virtualProcessorType);
				if (result == null) result = caseVirtualProcessorSubcomponentType(virtualProcessorType);
				if (result == null) result = caseClassifier(virtualProcessorType);
				if (result == null) result = caseSubcomponentType(virtualProcessorType);
				if (result == null) result = caseFeatureClassifier(virtualProcessorType);
				if (result == null) result = caseVirtualProcessor(virtualProcessorType);
				if (result == null) result = caseNamespace(virtualProcessorType);
				if (result == null) result = caseType(virtualProcessorType);
				if (result == null) result = caseNamedElement(virtualProcessorType);
				if (result == null) result = caseElement(virtualProcessorType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.VIRTUAL_PROCESSOR_IMPLEMENTATION: {
				...
				if (result == null) result = caseComponentImplementation(virtualProcessorImplementation);
				if (result == null) result = caseVirtualProcessorClassifier(virtualProcessorImplementation);
				if (result == null) result = caseComponentClassifier(virtualProcessorImplementation);
				if (result == null) result = caseVirtualProcessorSubcomponentType(virtualProcessorImplementation);
				if (result == null) result = caseClassifier(virtualProcessorImplementation);
				if (result == null) result = caseSubcomponentType(virtualProcessorImplementation);
				if (result == null) result = caseFeatureClassifier(virtualProcessorImplementation);
				if (result == null) result = caseVirtualProcessor(virtualProcessorImplementation);
				if (result == null) result = caseNamespace(virtualProcessorImplementation);
				if (result == null) result = caseType(virtualProcessorImplementation);
				if (result == null) result = caseNamedElement(virtualProcessorImplementation);
				if (result == null) result = caseElement(virtualProcessorImplementation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.VIRTUAL_PROCESSOR_PROTOTYPE: {
				...
				if (result == null) result = caseComponentPrototype(virtualProcessorPrototype);
				if (result == null) result = caseVirtualProcessorSubcomponentType(virtualProcessorPrototype);
				if (result == null) result = casePrototype(virtualProcessorPrototype);
				if (result == null) result = caseSubcomponentType(virtualProcessorPrototype);
				if (result == null) result = caseFeatureClassifier(virtualProcessorPrototype);
				if (result == null) result = caseVirtualProcessor(virtualProcessorPrototype);
				if (result == null) result = caseStructuralFeature(virtualProcessorPrototype);
				if (result == null) result = caseCalledSubprogram(virtualProcessorPrototype);
				if (result == null) result = caseType(virtualProcessorPrototype);
				if (result == null) result = caseRefinableElement(virtualProcessorPrototype);
				if (result == null) result = caseClassifierFeature(virtualProcessorPrototype);
				if (result == null) result = caseNamedElement(virtualProcessorPrototype);
				if (result == null) result = caseElement(virtualProcessorPrototype);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.BASIC_PROPERTY_ASSOCIATION: {
				...
				if (result == null) result = caseElement(basicPropertyAssociation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.PROPERTY_CONSTANT: {
				...
				if (result == null) result = caseTypedElement(propertyConstant);
				if (result == null) result = caseAbstractNamedValue(propertyConstant);
				if (result == null) result = caseArraySizeProperty(propertyConstant);
			...
			case Aadl2Package.STRING_LITERAL: {
				...
				if (result == null) result = casePropertyValue(stringLiteral);
			...
			case Aadl2Package.NUMBER_VALUE: {
				...
				if (result == null) result = casePropertyValue(numberValue);
				if (result == null) result = casePropertyExpression(numberValue);
				if (result == null) result = caseElement(numberValue);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.UNIT_LITERAL: {
				...
				if (result == null) result = caseEnumerationLiteral(unitLiteral);
				if (result == null) result = caseNamedElement(unitLiteral);
				if (result == null) result = caseAbstractNamedValue(unitLiteral);
				if (result == null) result = caseElement(unitLiteral);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.ENUMERATION_LITERAL: {
				...
				if (result == null) result = caseAbstractNamedValue(enumerationLiteral);
			...
			case Aadl2Package.CLASSIFIER_VALUE: {
				...
				if (result == null) result = casePropertyOwner(classifierValue);
				if (result == null) result = casePropertyValue(classifierValue);
				if (result == null) result = casePropertyExpression(classifierValue);
				if (result == null) result = caseElement(classifierValue);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.REFERENCE_VALUE: {
				...
				if (result == null) result = caseContainedNamedElement(referenceValue);
				if (result == null) result = casePropertyValue(referenceValue);
				if (result == null) result = casePropertyExpression(referenceValue);
				if (result == null) result = caseElement(referenceValue);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.BOOLEAN_LITERAL: {
				...
				if (result == null) result = casePropertyValue(booleanLiteral);
			...
			case Aadl2Package.RANGE_VALUE: {
				...
				if (result == null) result = casePropertyValue(rangeValue);
				if (result == null) result = casePropertyExpression(rangeValue);
				if (result == null) result = caseElement(rangeValue);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.INTEGER_LITERAL: {
				...
				if (result == null) result = caseNumberValue(integerLiteral);
				if (result == null) result = casePropertyValue(integerLiteral);
			...
			case Aadl2Package.REAL_LITERAL: {
				...
				if (result == null) result = caseNumberValue(realLiteral);
				if (result == null) result = casePropertyValue(realLiteral);
			...
			case Aadl2Package.OPERATION: {
				...
				if (result == null) result = casePropertyExpression(operation);
			...
			case Aadl2Package.RECORD_VALUE: {
				...
				if (result == null) result = casePropertyValue(recordValue);
				if (result == null) result = casePropertyExpression(recordValue);
			...
			case Aadl2Package.COMPUTED_VALUE: {
				...
				if (result == null) result = casePropertyValue(computedValue);
				if (result == null) result = casePropertyExpression(computedValue);
				if (result == null) result = caseElement(computedValue);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.LIST_VALUE: {
				...
				if (result == null) result = casePropertyExpression(listValue);
				if (result == null) result = caseElement(listValue);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.NAMED_VALUE: {
				...
				if (result == null) result = casePropertyValue(namedValue);
				if (result == null) result = casePropertyExpression(namedValue);
				if (result == null) result = caseElement(namedValue);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.PROPERTY_SET: {
				...
				if (result == null) result = caseNamespace(propertySet);
				if (result == null) result = caseModelUnit(propertySet);
				if (result == null) result = caseNamedElement(propertySet);
				if (result == null) result = caseElement(propertySet);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case Aadl2Package.NON_LIST_TYPE: {
				...
				if (result == null) result = casePropertyType(nonListType);
				if (result == null) result = caseType(nonListType);
				if (result == null) result = caseNamedElement(nonListType);
				if (result == null) result = caseElement(nonListType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.AADL_BOOLEAN: {
				...
				if (result == null) result = caseNonListType(aadlBoolean);
				if (result == null) result = casePropertyType(aadlBoolean);
				if (result == null) result = caseType(aadlBoolean);
				if (result == null) result = caseNamedElement(aadlBoolean);
				if (result == null) result = caseElement(aadlBoolean);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.AADL_STRING: {
				...
				if (result == null) result = caseNonListType(aadlString);
				if (result == null) result = casePropertyType(aadlString);
				if (result == null) result = caseType(aadlString);
				if (result == null) result = caseNamedElement(aadlString);
				if (result == null) result = caseElement(aadlString);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.AADL_INTEGER: {
				...
				if (result == null) result = caseNumberType(aadlInteger);
				if (result == null) result = caseNonListType(aadlInteger);
				if (result == null) result = casePropertyType(aadlInteger);
				if (result == null) result = caseType(aadlInteger);
				if (result == null) result = caseNamedElement(aadlInteger);
				if (result == null) result = caseElement(aadlInteger);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.NUMBER_TYPE: {
				...
				if (result == null) result = caseNonListType(numberType);
				if (result == null) result = casePropertyType(numberType);
				if (result == null) result = caseType(numberType);
				if (result == null) result = caseNamedElement(numberType);
				if (result == null) result = caseElement(numberType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.UNITS_TYPE: {
				...
				if (result == null) result = caseEnumerationType(unitsType);
				if (result == null) result = caseNamespace(unitsType);
				if (result == null) result = caseNonListType(unitsType);
				if (result == null) result = casePropertyType(unitsType);
				if (result == null) result = caseElement(unitsType);
				if (result == null) result = caseType(unitsType);
				if (result == null) result = caseNamedElement(unitsType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.ENUMERATION_TYPE: {
				...
				if (result == null) result = caseNonListType(enumerationType);
				if (result == null) result = casePropertyType(enumerationType);
			...
			case Aadl2Package.NUMERIC_RANGE: {
				...
				if (result == null) result = caseElement(numericRange);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.AADL_REAL: {
				...
				if (result == null) result = caseNumberType(aadlReal);
				if (result == null) result = caseNonListType(aadlReal);
				if (result == null) result = casePropertyType(aadlReal);
				if (result == null) result = caseType(aadlReal);
				if (result == null) result = caseNamedElement(aadlReal);
				if (result == null) result = caseElement(aadlReal);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.CLASSIFIER_TYPE: {
				...
				if (result == null) result = caseNonListType(classifierType);
				if (result == null) result = casePropertyType(classifierType);
			...
			case Aadl2Package.RANGE_TYPE: {
				...
				if (result == null) result = caseNonListType(rangeType);
				if (result == null) result = casePropertyType(rangeType);
			...
			case Aadl2Package.RECORD_TYPE: {
				...
				if (result == null) result = caseNamespace(recordType);
				if (result == null) result = caseNonListType(recordType);
				if (result == null) result = casePropertyType(recordType);
			...
			case Aadl2Package.RECORD_FIELD: {
				...
				if (result == null) result = caseBasicProperty(recordField);
				if (result == null) result = caseTypedElement(recordField);
				if (result == null) result = caseNamedElement(recordField);
			...
			case Aadl2Package.REFERENCE_TYPE: {
				...
				if (result == null) result = caseNonListType(referenceType);
				if (result == null) result = casePropertyType(referenceType);
				if (result == null) result = caseType(referenceType);
				if (result == null) result = caseNamedElement(referenceType);
				if (result == null) result = caseElement(referenceType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Aadl2Package.LIST_TYPE: {
				...
				if (result == null) result = casePropertyType(listType);
	 ...
	 * @generated
	 */
	public T casePackage(aadl2.Package object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseThreadGroup(aadl2.ThreadGroup object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseThread(aadl2.Thread object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseSystem(aadl2.System object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseProcess(aadl2.Process object) {
		return null;
	}
